...
namespace ModelServicesPrismModule.Phonebook.LpdEmpLastName {
    public class LpdEmpLastNameViewService: ILpdEmpLastNameViewService
    {
        ...
        public LpdEmpLastNameViewService(IAppGlblSettingsService agstt) {
      ...
      {"EmpLastNameId", ("EmpLastNameId", "", "", true, false, true, true, "int32")},  // System.Int32
      {"EmpLastName", ("EmpLastName", "", "", false, true, true, false, "string")},  // System.String
            };
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), object> getHiddenFilterByRow(ILpdEmpLastNameView rw, string nvNm) {
        ...
        foreach(string i in this._Values.Keys) {
            if(this.isInPrimkeyValue(i) || this.IsInUnkKeyValue(i)) {
                rslt[("LpdEmpLastNameView",nvNm,i)] = rw.GetType().GetProperty(i).GetValue(rw);
            }
        }
        return rslt;
    }
    ...
    protected  Dictionary<(string viewNm, string navNm, string propNm), string> _C2mfm = 
        new Dictionary<(string viewNm, string navNm, string propNm), string>() {
    {("LprEmployee01View", "EmpLastNameDict", "EmpLastNameIdRef"), "EmpLastNameId"},
    {("LprEmployee02View", "EmpLastNameDict", "EmpLastNameIdRef"), "EmpLastNameId"},
    };
    public Dictionary<(string viewNm, string navNm, string propNm), string> getC2mfm() {
        ...
        public async Task<IList<ILpdEmpLastNameView>> getall() {
            try
            {
                HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getall");
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return new List<ILpdEmpLastNameView>( JsonConvert.DeserializeObject<IList<LpdEmpLastNameView>>(responseBody) );
            } 
            catch(Exception e)
            {
                string exceptionMsg = "LpdEmpLastNameViewService.getall : " + e.Message;
        ...
        public async Task<ILpdEmpLastNameViewPage> getwithfilter(ILpdEmpLastNameViewFilter filter) {
            string prms = null;
            if(filter != null) {
                if (filter.EmpLastNameId != null) {
                    foreach(var val in filter.EmpLastNameId) {
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("empLastNameId") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms = "?" + Uri.EscapeDataString("empLastNameId") + "=" + Uri.EscapeDataString(val.ToString());
                            else 
                                //prms += "&" + Uri.EscapeDataString("empLastNameId") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms += "&" + Uri.EscapeDataString("empLastNameId") + "=" + Uri.EscapeDataString(val.ToString());
                ...
                if(filter.empLastNameIdOprtr != null) {
                    foreach(var val in filter.empLastNameIdOprtr) {
                        if(val != null) {
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("empLastNameIdOprtr") + "[]=" +  Uri.EscapeDataString(val.ToString());
                                prms = "?" + Uri.EscapeDataString("empLastNameIdOprtr") + "=" +  Uri.EscapeDataString(val.ToString());
                            else 
                                //prms += "&" + Uri.EscapeDataString("empLastNameIdOprtr") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms += "&" + Uri.EscapeDataString("empLastNameIdOprtr") + "=" + Uri.EscapeDataString(val.ToString());
                            ...
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("empLastNameIdOprtr") + "[]=" +  Uri.EscapeDataString("eq");
                                prms = "?" + Uri.EscapeDataString("empLastNameIdOprtr") + "=" +  Uri.EscapeDataString("eq");
                            else 
                                //prms += "&" + Uri.EscapeDataString("empLastNameIdOprtr") + "[]=" + Uri.EscapeDataString("eq");
                                prms += "&" + Uri.EscapeDataString("empLastNameIdOprtr") + "=" + Uri.EscapeDataString("eq");
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<LpdEmpLastNameViewPage>(responseBody) ;
            } 
            catch(Exception e)
            {
                string exceptionMsg = "LpdEmpLastNameViewService.getwithfilter : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    // });
    // 
    public async Task<ILpdEmpLastNameView> getone(
        System.Int32 EmpLastNameId 
        ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("empLastNameId") + "=" +  Uri.EscapeDataString(EmpLastNameId.ToString());
                else 
                    prms += "&" + Uri.EscapeDataString("empLastNameId") + "=" + Uri.EscapeDataString(EmpLastNameId.ToString());
            if(prms == null) prms = "";
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<LpdEmpLastNameView>(responseBody) ;
            } 
            catch(Exception e) 
            {
                string exceptionMsg = "LpdEmpLastNameViewService.getone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    public async Task<ILpdEmpLastNameViewPage> getmanybyrepprim(ILpdEmpLastNameViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.EmpLastNameId != null) {
                    foreach(var val in filter.EmpLastNameId) {
        ...
        {
            string exceptionMsg = "LpdEmpLastNameViewService.getmanybyrepprim : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    // });
    // 
    public async Task<ILpdEmpLastNameView> getonebyLpdEmpLastNameUK(
        System.String EmpLastName 
        ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("empLastName") + "=" +  Uri.EscapeDataString(EmpLastName.ToString());
                else 
                    prms += "&" + Uri.EscapeDataString("empLastName") + "=" + Uri.EscapeDataString(EmpLastName.ToString());
            if(prms == null) prms = "";
            try
    ...
    public async Task<ILpdEmpLastNameViewPage> getmanybyrepunqLpdEmpLastNameUK(ILpdEmpLastNameViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.EmpLastName != null) {
                    foreach(var val in filter.EmpLastName) {
        ...
        try
        {
            HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getmanybyrepunqLpdEmpLastNameUK" + prms);
            response.EnsureSuccessStatusCode();
            string responseBody = await response.Content.ReadAsStringAsync();
            return  JsonConvert.DeserializeObject<LpdEmpLastNameViewPage>(responseBody) ;
        } 
        ...
        {
            string exceptionMsg = "LpdEmpLastNameViewService.getmanybyrepunqLpdEmpLastNameUK : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILpdEmpLastNameView> updateone(ILpdEmpLastNameView item) {
            if(item == null) {
            ...
            {
                string exceptionMsg = "LpdEmpLastNameViewService.updateone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILpdEmpLastNameView> addone(ILpdEmpLastNameView item) {
            if(item == null) {
                appGlblSettings.ShowErrorMessage("http", "Input item is not defined");
                return null;
            }
            ...
            {
                string exceptionMsg = "LpdEmpLastNameViewService.addone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILpdEmpLastNameView> deleteone(System.Int32 EmpLastNameId ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("empLastNameId") + "=" +  Uri.EscapeDataString(EmpLastNameId.ToString());
                else 
            ...
            {
                string exceptionMsg = "LpdEmpLastNameViewService.deleteone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public ILpdEmpLastNameViewNotify CopyToModelNotify(ILpdEmpLastNameView  src, ILpdEmpLastNameViewNotify dest = null) {
            if(dest == null) dest = new LpdEmpLastNameViewNotify();
            if(src == null) return dest;
            dest.EmpLastNameId = src.EmpLastNameId;
            dest.EmpLastName = src.EmpLastName;
            return dest;
        }
        public ILpdEmpLastNameView CopyToModel(ILpdEmpLastNameView  src, ILpdEmpLastNameView dest = null) {
            if(dest == null) dest = new LpdEmpLastNameView();
            if(src == null) return dest;
            dest.EmpLastNameId = src.EmpLastNameId;
            dest.EmpLastName = src.EmpLastName;
            return dest;
        ...
        public ILpdEmpLastNameViewFilter GetFilter() {
            return new LpdEmpLastNameViewFilter();
        }

        public IList<IWebServiceFilterRsltInterface> Row2FilterRslt(ILpdEmpLastNameView r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
        ...
        public IList<IWebServiceFilterRsltInterface> RowPrim2FilterRslt(ILpdEmpLastNameView r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
            if (r == null) return rslt;
            foreach(string i in this._Values.Keys) {
        ...
        public ILpdEmpLastNameViewFilter FilterRslt2Filter(IWebServiceFilterRsltInterface e, ILpdEmpLastNameViewFilter dest) {
            ILpdEmpLastNameViewFilter flt = dest;
            if(dest is null) {
                flt = GetFilter();
            }
            ...
            switch(e.fltrName) {
                case "EmpLastNameId":
                    ...
                    flt.EmpLastNameId.Add((System.Int32)e.fltrValue);
                    if (flt.empLastNameIdOprtr == null) flt.empLastNameIdOprtr = new List<string>();
                    flt.empLastNameIdOprtr.Add(e.fltrOperator);
                    break;
                case "EmpLastName":
        ...
        public ILpdEmpLastNameViewFilter FilterRslt2Filter(IList<IWebServiceFilterRsltInterface> src, ILpdEmpLastNameViewFilter dest) {
            ILpdEmpLastNameViewFilter rslt = dest;
            if(dest is null) {
                rslt = GetFilter();
            }
