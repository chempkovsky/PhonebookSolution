...
/*
    In the file of IModule-class of the project for the current service the following lines of code must be inserted:
        ...
        {
            ...
            containerRegistry.Register<ILprEmployee01ViewDatasource, LprEmployee01ViewDatasource>();
            ...
        }

*/
namespace ModelServicesPrismModule.Phonebook.LprEmployee01 {
    public class LprEmployee01ViewDatasource: ILprEmployee01ViewDatasource
    {
        protected readonly string _CurrentViewName   = "LprEmployee01View";
        ...
        protected ILprEmployee01ViewService frmRootSrv;
        protected IAppGlblSettingsService appGlblSettings;

        public LprEmployee01ViewDatasource(ILprEmployee01ViewService frs,
        ...
        public bool Interface2Values(ILprEmployee01View data, bool doNotify = true) {
            if(data == null) {
        ...
        public ILprEmployee01View Values2Interface() {
            object locobjval;

            LprEmployee01View rslt = new LprEmployee01View(); 
        ...
        protected ILprEmployee01ViewFilter DefineFilterOneProp(ILprEmployee01ViewFilter flt, string propNm, object value, string Oprtr) {
            if(flt == null) flt = new LprEmployee01ViewFilter(); 
        ...
        protected ILprEmployee01ViewFilter GetFilterByCurrDirMstrs() {
            ILprEmployee01ViewFilter flt = new LprEmployee01ViewFilter(); 
            Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)> M2cKeyfm = this.frmRootSrv.getM2cKeyfm();
            foreach(var lkey in M2cKeyfm.Keys) {
                if (this.isSetValue(M2cKeyfm[lkey].propNm)) {
        ...
        public async Task<IList<ILprEmployee01View>> GetClActionByCurrDirMstrs() {
            if (!this.IsSetFilterByCurrDirMstrs()) {
                return new List<ILprEmployee01View>();
            }
            ILprEmployee01ViewPage prslt = await this.frmRootSrv.getwithfilter(this.GetFilterByCurrDirMstrs());
            if(prslt == null) {
                return new List<ILprEmployee01View>();
            }
            if(prslt.items == null) {
        ...
        public async Task<IList<ILprEmployee01View>> GetClActionByFldFilter(string fldName, object fldVal) {
            ...
            ILprEmployee01ViewFilter flt = this.GetFilterByCurrDirMstrs();
            this.DefineFilterOneProp(flt, fldName, fldVal, "lk");
            if (flt.orderby == null) flt.orderby = new List<string>();
            flt.orderby.Add(fldName);
            ILprEmployee01ViewPage prslt = await this.frmRootSrv.getwithfilter(flt);
            if(prslt == null) {
                return new List<ILprEmployee01View>();
            }
            if(prslt.items == null) {
        ...
        public async Task getone(
            ...
            ILprEmployee01View data = await this.frmRootSrv.getone(
                  EmpLastNameIdRef
                , EmpFirstNameIdRef
                , EmpSecondNameIdRef
                , EmployeeId
        ...
        public async Task updateone() {
            ...
            ILprEmployee01View itm = this.Values2Interface();
            ILprEmployee01View data = await this.frmRootSrv.updateone(itm);
            if(data != null) {
        ...
        public async Task addone() {
            ...
            ILprEmployee01View itm = this.Values2Interface();
            ILprEmployee01View data = await this.frmRootSrv.addone(itm);
            if(data != null) {
                this.Interface2Values(data, false);
        ...
        public async Task deleteone() {
            ...
            ILprEmployee01View data = await this.frmRootSrv.deleteone(  locEmpLastNameIdRef ,   locEmpFirstNameIdRef ,   locEmpSecondNameIdRef ,   locEmployeeId );
            if(data != null) {
                this.Interface2Values(data, false);
