...
/*
    In the file of IModule-class of the project for the current service the following lines of code must be inserted:
        ...
        {
            ...
            containerRegistry.Register<ILprPhone01ViewDatasource, LprPhone01ViewDatasource>();
            ...
        }

*/
namespace ModelServicesPrismModule.Phonebook.LprPhone01 {
    public class LprPhone01ViewDatasource: ILprPhone01ViewDatasource
    {
        protected readonly string _CurrentViewName   = "LprPhone01View";
        ...
        protected ILprPhone01ViewService frmRootSrv;
        protected IAppGlblSettingsService appGlblSettings;

        public LprPhone01ViewDatasource(ILprPhone01ViewService frs,
        ...
        public bool Interface2Values(ILprPhone01View data, bool doNotify = true) {
            if(data == null) {
        ...
        public ILprPhone01View Values2Interface() {
            object locobjval;

            LprPhone01View rslt = new LprPhone01View(); 
        ...
        protected ILprPhone01ViewFilter DefineFilterOneProp(ILprPhone01ViewFilter flt, string propNm, object value, string Oprtr) {
            if(flt == null) flt = new LprPhone01ViewFilter(); 
        ...
        protected ILprPhone01ViewFilter GetFilterByCurrDirMstrs() {
            ILprPhone01ViewFilter flt = new LprPhone01ViewFilter(); 
            Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)> M2cKeyfm = this.frmRootSrv.getM2cKeyfm();
            foreach(var lkey in M2cKeyfm.Keys) {
                if (this.isSetValue(M2cKeyfm[lkey].propNm)) {
        ...
        public async Task<IList<ILprPhone01View>> GetClActionByCurrDirMstrs() {
            if (!this.IsSetFilterByCurrDirMstrs()) {
                return new List<ILprPhone01View>();
            }
            ILprPhone01ViewPage prslt = await this.frmRootSrv.getwithfilter(this.GetFilterByCurrDirMstrs());
            if(prslt == null) {
                return new List<ILprPhone01View>();
            }
            if(prslt.items == null) {
        ...
        public async Task<IList<ILprPhone01View>> GetClActionByFldFilter(string fldName, object fldVal) {
            ...
            ILprPhone01ViewFilter flt = this.GetFilterByCurrDirMstrs();
            this.DefineFilterOneProp(flt, fldName, fldVal, "lk");
            if (flt.orderby == null) flt.orderby = new List<string>();
            flt.orderby.Add(fldName);
            ILprPhone01ViewPage prslt = await this.frmRootSrv.getwithfilter(flt);
            if(prslt == null) {
                return new List<ILprPhone01View>();
            }
            if(prslt.items == null) {
        ...
        public async Task getone(
            ...
            ILprPhone01View data = await this.frmRootSrv.getone(
                  LpdPhoneIdRef
                , PhoneId
            );
            if(data != null) {
        ...
        public async Task updateone() {
            ...
            ILprPhone01View itm = this.Values2Interface();
            ILprPhone01View data = await this.frmRootSrv.updateone(itm);
            if(data != null) {
        ...
        public async Task addone() {
            ...
            ILprPhone01View itm = this.Values2Interface();
            ILprPhone01View data = await this.frmRootSrv.addone(itm);
            if(data != null) {
                this.Interface2Values(data, false);
        ...
        public async Task deleteone() {
            ...
            ILprPhone01View data = await this.frmRootSrv.deleteone(  locLpdPhoneIdRef ,   locPhoneId );
            if(data != null) {
                this.Interface2Values(data, false);
