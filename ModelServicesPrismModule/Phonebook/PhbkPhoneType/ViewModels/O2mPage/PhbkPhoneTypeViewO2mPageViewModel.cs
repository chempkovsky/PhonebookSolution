...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels.O2mPage {

    public class PhbkPhoneTypeViewO2mPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkPhoneTypeViewService FrmRootSrvPhbkPhoneTypeView = null;
        protected INavigationService _navigationService;
        protected IPhbkPhoneViewService FrmSrvPhbkPhoneView = null;
        public PhbkPhoneTypeViewO2mPageViewModel(IPhbkPhoneTypeViewService _FrmRootSrvPhbkPhoneTypeView, 
            ...
            this.FrmRootSrvPhbkPhoneTypeView = _FrmRootSrvPhbkPhoneTypeView;
            ...
            if((SelectedDetailsListItem != null) && (selectedMasterRow != null)) {
                switch(SelectedDetailsListItem.ForeignKeyDetails) {
                    case "PhbkPhoneViewLformUserControl:PhoneType":
                        ...
                        tmpFlt = this.FrmSrvPhbkPhoneView.getHiddenFilterAsFltRslt(this.FrmRootSrvPhbkPhoneTypeView.getHiddenFilterByRow(selectedMasterRow, "PhoneType"));
                        break;
                    default:
                        break;
                }
