...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels {
    ...
    public class PhbkPhoneTypeViewRdlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkPhoneTypeViewService FrmSrvPhbkPhoneTypeView = null;
        protected INavigationService _navigationService;
        public PhbkPhoneTypeViewRdlistPageViewModel(IPhbkPhoneTypeViewService _FrmSrvPhbkPhoneTypeView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkPhoneViewRdlistPagePhoneType", Caption="Phones: PhoneType", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null},
//
//  Warning:
//  "02017-RdlistPage.xaml.cs" type has not been generated for LprPhone03View
//
//
//  Warning:
...
//
        ...
        protected async void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                case "RowMIPhbkPhoneViewRdlistPagePhoneType":
                    await NavigateToDetailCommand(arow, "PhbkPhoneView", "PhoneType", "PhbkPhoneViewRdlistPage");
                    break;
//
//  Warning:
//  "02017-RdlistPage.xaml.cs" type has not been generated for LprPhone03View
