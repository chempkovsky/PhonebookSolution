...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels {
    public class PhbkPhoneTypeViewRdelPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public PhbkPhoneTypeViewRdelPageViewModel(IPhbkPhoneTypeViewService _FrmSrvPhbkPhoneTypeView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((modeToCheck == EformModeEnum.DeleteMode) && ((GlblSettingsSrv.GetViewModelMask("PhbkPhoneTypeView") & 2) != 2 )) {
                throw new Exception("Access denied to delete PhbkPhoneTypeView");
            } else if ((modeToCheck == EformModeEnum.UpdateMode) && ((GlblSettingsSrv.GetViewModelMask("PhbkPhoneTypeView") & 4) != 4 )) {
                throw new Exception("Access denied to update PhbkPhoneTypeView");
            } else if ((modeToCheck == EformModeEnum.AddMode) && ((GlblSettingsSrv.GetViewModelMask("PhbkPhoneTypeView") & 8) != 8 )) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "Delete item for Phone Type";
                ...
                _ = FrmSrvPhbkPhoneTypeView.getone(
                    pkpPhoneTypeId
                        ...
                        MainThread.InvokeOnMainThreadAsync(() =>
                        {
                            ...
                            EformMode = locmode;
                            FormControlModel = FrmSrvPhbkPhoneTypeView.CopyToModelNotify(data.Result, null);
                            IsParentLoaded = true;
                        });
                });
        }
