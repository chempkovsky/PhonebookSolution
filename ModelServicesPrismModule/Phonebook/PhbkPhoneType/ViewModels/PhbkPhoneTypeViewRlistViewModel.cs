...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels {
    ...
    public class PhbkPhoneTypeViewRlistViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkPhoneTypeViewService FrmSrvPhbkPhoneTypeView = null;
        public PhbkPhoneTypeViewRlistViewModel(IPhbkPhoneTypeViewService _FrmSrvPhbkPhoneTypeView, 
        ...
        public void NavigateToDetailCommand(IPhbkPhoneTypeView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                ...
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkPhoneViewRlistUserControlPhoneType", Caption="Phones: PhoneType", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
...
//
        ...
        public void SformAddItemCommand() {
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkPhoneTypeViewRaddUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        public void SformUpdItemCommand(IPhbkPhoneTypeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if (!CanUpdate) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkPhoneTypeViewRupdUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion

        #region SformDelItemCommand
        public void SformDelItemCommand(IPhbkPhoneTypeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if(!CanDelete) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpPhoneTypeId", selected.PhoneTypeId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkPhoneTypeViewRdelUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        
        #region SformViewItemCommand
        public void SformViewItemCommand(IPhbkPhoneTypeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpPhoneTypeId", selected.PhoneTypeId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkPhoneTypeViewRviewUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            switch(mi.Id) {
                ...
                case "RowMIPhbkPhoneViewRlistUserControlPhoneType":
                    NavigateToDetailCommand(arow, "PhbkPhoneView", "PhoneType", "PhbkPhoneViewRlistUserControl");
                    break;
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprPhone03View
