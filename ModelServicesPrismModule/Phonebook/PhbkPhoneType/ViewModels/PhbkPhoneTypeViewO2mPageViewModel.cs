...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels {
    ...
    public class PhbkPhoneTypeViewO2mPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        ...
        public PhbkPhoneTypeViewO2mPageViewModel(IPhbkPhoneTypeViewService _FrmSrvPhbkPhoneTypeView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
