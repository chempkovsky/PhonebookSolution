...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels {
    public class PhbkPhoneTypeViewRaddPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public PhbkPhoneTypeViewRaddPageViewModel(IPhbkPhoneTypeViewService _FrmSrvPhbkPhoneTypeView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
