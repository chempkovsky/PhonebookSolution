...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.ViewModels {
    ...
    public class PhbkPhoneTypeViewRdlistViewModel: RegionAwareViewModelBase, IRegionAware
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkPhoneTypeViewService FrmSrvPhbkPhoneTypeView = null;
        
        public PhbkPhoneTypeViewRdlistViewModel(IPhbkPhoneTypeViewService _FrmSrvPhbkPhoneTypeView, IAppGlblSettingsService GlblSettingsSrv) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkPhoneViewRdlistUserControlPhoneType", Caption="Phones: PhoneType", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
//  "02016-RdlistUserControl.xaml.cs" type has not been generated for LprPhone03View
//
//
//  Warning:
...
//
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                case "RowMIPhbkPhoneViewRdlistUserControlPhoneType":
                    NavigateToDetailCommand(arow, "PhbkPhoneView", "PhoneType", "PhbkPhoneViewRdlistUserControl");
                    break;
//
//  Warning:
//  "02016-RdlistUserControl.xaml.cs" type has not been generated for LprPhone03View
