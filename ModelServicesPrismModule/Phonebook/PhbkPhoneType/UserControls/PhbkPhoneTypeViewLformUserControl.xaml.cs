...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.UserControls {
    /// <summary>
    /// Interaction logic for PhbkPhoneTypeViewLformUserControl.xaml
    /// </summary>
    public partial class PhbkPhoneTypeViewLformUserControl: LformUserControlBase
    {
        public PhbkPhoneTypeViewLformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
