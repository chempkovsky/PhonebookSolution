...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.Views {
    /// <summary>
    /// Interaction logic for PhbkPhoneTypeViewRupdPage.xaml
    /// </summary>
    public partial class PhbkPhoneTypeViewRupdPage: ContentPage, IDestructible
    {
        public PhbkPhoneTypeViewRupdPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkPhoneTypeViewRupdPage inst = d as PhbkPhoneTypeViewRupdPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkPhoneTypeViewRupdPage),
