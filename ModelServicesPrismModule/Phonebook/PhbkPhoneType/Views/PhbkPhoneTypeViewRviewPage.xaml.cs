...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.Views {
    /// <summary>
    /// Interaction logic for PhbkPhoneTypeViewRviewPage.xaml
    /// </summary>
    public partial class PhbkPhoneTypeViewRviewPage: ContentPage, IDestructible
    {
        public PhbkPhoneTypeViewRviewPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkPhoneTypeViewRviewPage inst = d as PhbkPhoneTypeViewRviewPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkPhoneTypeViewRviewPage),
