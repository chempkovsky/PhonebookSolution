...
namespace ModelServicesPrismModule.Phonebook.PhbkPhoneType.Views {
    /// <summary>
    /// Interaction logic for PhbkPhoneTypeViewRdelPage.xaml
    /// </summary>
    public partial class PhbkPhoneTypeViewRdelPage: ContentPage, IDestructible
    {
        public PhbkPhoneTypeViewRdelPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkPhoneTypeViewRdelPage inst = d as PhbkPhoneTypeViewRdelPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkPhoneTypeViewRdelPage),
