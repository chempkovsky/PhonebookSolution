...
namespace ModelServicesPrismModule.Phonebook.PhbkPhone.Views {
    /// <summary>
    /// Interaction logic for PhbkPhoneViewRaddPage.xaml
    /// </summary>
    public partial class PhbkPhoneViewRaddPage: ContentPage, IDestructible
    {
        public PhbkPhoneViewRaddPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkPhoneViewRaddPage inst = d as PhbkPhoneViewRaddPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
