...
namespace ModelServicesPrismModule.Phonebook.PhbkPhone.Views {
    /// <summary>
    /// Interaction logic for PhbkPhoneViewRdelPage.xaml
    /// </summary>
    public partial class PhbkPhoneViewRdelPage: ContentPage, IDestructible
    {
        public PhbkPhoneViewRdelPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkPhoneViewRdelPage inst = d as PhbkPhoneViewRdelPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
