...
namespace ModelServicesPrismModule.Phonebook.PhbkPhone.Views {
    /// <summary>
    /// Interaction logic for PhbkPhoneViewRdlistPage.xaml
    /// </summary>
    public partial class PhbkPhoneViewRdlistPage: ContentPage, IDestructible 
    {
        public PhbkPhoneViewRdlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkPhoneViewRdlistPage inst = d as PhbkPhoneViewRdlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkPhoneViewRdlistPage),
