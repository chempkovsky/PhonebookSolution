...
namespace ModelServicesPrismModule.Phonebook.PhbkPhone.ViewModels {
    ...
    public class PhbkPhoneViewRlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkPhoneViewService FrmSrvPhbkPhoneView = null;
        protected INavigationService _navigationService;
        public PhbkPhoneViewRlistPageViewModel(IPhbkPhoneViewService _FrmSrvPhbkPhoneView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
...
//
//  Warning:
//  "01917-RlistPage.xaml.cs" type has not been generated for LprPhone01View
//
//
//  Warning:
...
//
        ...
        public async Task NavigateToDetailCommand(IPhbkPhoneView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
            if(IsDestroyed) return;
        ...
        public async Task SformAddItemCommand() {
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkPhoneViewRaddPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
        ...
        public async Task SformUpdItemCommand(IPhbkPhoneView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkPhoneViewRupdPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformDelItemCommand
        public async Task SformDelItemCommand(IPhbkPhoneView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            navigationParameters.Add("pkpPhoneId", selected.PhoneId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkPhoneViewRdelPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformViewItemCommand
        public async Task SformViewItemCommand(IPhbkPhoneView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpPhoneId", selected.PhoneId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkPhoneViewRviewPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
