...
namespace ModelServicesPrismModule.Phonebook.PhbkPhone.UserControls {
    /// <summary>
    /// Interaction logic for PhbkPhoneViewSformUserControl.xaml
    /// </summary>
    public partial class PhbkPhoneViewSformUserControl: SformUserControlBase
    {
        public PhbkPhoneViewSformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
