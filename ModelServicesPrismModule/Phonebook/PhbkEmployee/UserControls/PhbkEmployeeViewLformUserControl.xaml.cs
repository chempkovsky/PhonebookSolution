...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.UserControls {
    /// <summary>
    /// Interaction logic for PhbkEmployeeViewLformUserControl.xaml
    /// </summary>
    public partial class PhbkEmployeeViewLformUserControl: LformUserControlBase
    {
        public PhbkEmployeeViewLformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
