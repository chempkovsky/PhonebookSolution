...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.UserControls {
    /// <summary>
    /// Interaction logic for PhbkEmployeeViewDformUserControl.xaml
    /// </summary>
    public partial class PhbkEmployeeViewDformUserControl: EformUserControlBase
    {
        public PhbkEmployeeViewDformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
