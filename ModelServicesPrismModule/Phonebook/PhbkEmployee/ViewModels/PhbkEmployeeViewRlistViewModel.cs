...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.ViewModels {
    ...
    public class PhbkEmployeeViewRlistViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkEmployeeViewService FrmSrvPhbkEmployeeView = null;
        public PhbkEmployeeViewRlistViewModel(IPhbkEmployeeViewService _FrmSrvPhbkEmployeeView, 
...
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprEmployee01View
//
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprEmployee02View
//
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkPhoneViewRlistUserControlEmployee", Caption="Phones: Employee", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
...
//
        ...
        public void SformAddItemCommand() {
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEmployeeViewRaddUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        public void SformUpdItemCommand(IPhbkEmployeeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if (!CanUpdate) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEmployeeViewRupdUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion

        #region SformDelItemCommand
        public void SformDelItemCommand(IPhbkEmployeeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if(!CanDelete) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpEmployeeId", selected.EmployeeId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEmployeeViewRdelUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        
        #region SformViewItemCommand
        public void SformViewItemCommand(IPhbkEmployeeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpEmployeeId", selected.EmployeeId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEmployeeViewRviewUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
...
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprEmployee02View
//
                case "RowMIPhbkPhoneViewRlistUserControlEmployee":
                    NavigateToDetailCommand(arow, "PhbkPhoneView", "Employee", "PhbkPhoneViewRlistUserControl");
                    break;
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprPhone02View
