...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.ViewModels {
    ...
    public class PhbkEmployeeViewRlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkEmployeeViewService FrmSrvPhbkEmployeeView = null;
        protected INavigationService _navigationService;
        public PhbkEmployeeViewRlistPageViewModel(IPhbkEmployeeViewService _FrmSrvPhbkEmployeeView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
...
//
//  Warning:
//  "01917-RlistPage.xaml.cs" type has not been generated for LprEmployee01View
//
//
//  Warning:
//  "01917-RlistPage.xaml.cs" type has not been generated for LprEmployee02View
//
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkPhoneViewRlistPageEmployee", Caption="Phones: Employee", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
//  "01917-RlistPage.xaml.cs" type has not been generated for LprPhone02View
//
//
//  Warning:
...
//
        ...
        public async Task NavigateToDetailCommand(IPhbkEmployeeView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
            if(IsDestroyed) return;
        ...
        public async Task SformAddItemCommand() {
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEmployeeViewRaddPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
        ...
        public async Task SformUpdItemCommand(IPhbkEmployeeView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            navigationParameters.Add("pkpEmployeeId", selected.EmployeeId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEmployeeViewRupdPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformDelItemCommand
        public async Task SformDelItemCommand(IPhbkEmployeeView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            navigationParameters.Add("pkpEmployeeId", selected.EmployeeId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEmployeeViewRdelPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformViewItemCommand
        public async Task SformViewItemCommand(IPhbkEmployeeView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpEmployeeId", selected.EmployeeId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEmployeeViewRviewPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
...
//  "01917-RlistPage.xaml.cs" type has not been generated for LprEmployee02View
//
                case "RowMIPhbkPhoneViewRlistPageEmployee":
                    await NavigateToDetailCommand(arow, "PhbkPhoneView", "Employee", "PhbkPhoneViewRlistPage");
                    break;
//
//  Warning:
//  "01917-RlistPage.xaml.cs" type has not been generated for LprPhone02View
       ...
       public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if (prms.ContainsKey("EformModeEnum")) {
                ...
                if ((mode == EformModeEnum.AddMode) || (mode == EformModeEnum.UpdateMode)) {
                    ...
                    IPhbkEmployeeView data = FrmSrvPhbkEmployeeView.CopyToModel(null,null);
                    data.EmployeeId = pkpEmployeeId;
