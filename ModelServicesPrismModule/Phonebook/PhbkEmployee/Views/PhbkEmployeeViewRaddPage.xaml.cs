...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.Views {
    /// <summary>
    /// Interaction logic for PhbkEmployeeViewRaddPage.xaml
    /// </summary>
    public partial class PhbkEmployeeViewRaddPage: ContentPage, IDestructible
    {
        public PhbkEmployeeViewRaddPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEmployeeViewRaddPage inst = d as PhbkEmployeeViewRaddPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEmployeeViewRaddPage),
