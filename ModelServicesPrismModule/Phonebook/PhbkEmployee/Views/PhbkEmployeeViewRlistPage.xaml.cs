...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.Views {
    /// <summary>
    /// Interaction logic for PhbkEmployeeViewRlistPage.xaml
    /// </summary>
    public partial class PhbkEmployeeViewRlistPage: ContentPage, IDestructible 
    {
        public PhbkEmployeeViewRlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEmployeeViewRlistPage inst = d as PhbkEmployeeViewRlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEmployeeViewRlistPage),
