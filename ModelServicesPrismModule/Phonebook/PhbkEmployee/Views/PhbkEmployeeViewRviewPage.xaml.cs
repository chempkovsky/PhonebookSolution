...
namespace ModelServicesPrismModule.Phonebook.PhbkEmployee.Views {
    /// <summary>
    /// Interaction logic for PhbkEmployeeViewRviewPage.xaml
    /// </summary>
    public partial class PhbkEmployeeViewRviewPage: ContentPage, IDestructible
    {
        public PhbkEmployeeViewRviewPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEmployeeViewRviewPage inst = d as PhbkEmployeeViewRviewPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEmployeeViewRviewPage),
