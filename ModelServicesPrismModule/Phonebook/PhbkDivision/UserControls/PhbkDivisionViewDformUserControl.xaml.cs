...
namespace ModelServicesPrismModule.Phonebook.PhbkDivision.UserControls {
    /// <summary>
    /// Interaction logic for PhbkDivisionViewDformUserControl.xaml
    /// </summary>
    public partial class PhbkDivisionViewDformUserControl: EformUserControlBase
    {
        public PhbkDivisionViewDformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
