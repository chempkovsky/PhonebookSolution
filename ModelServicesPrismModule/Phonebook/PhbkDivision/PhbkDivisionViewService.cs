...
namespace ModelServicesPrismModule.Phonebook.PhbkDivision {
    public class PhbkDivisionViewService: IPhbkDivisionViewService
    {
        ...
        public PhbkDivisionViewService(IAppGlblSettingsService agstt) {
            this.appGlblSettings = agstt;
            this.serviceUrl = this.appGlblSettings.GetWebApiPrefix("PhbkDivisionView") + "phbkdivisionviewwebapi";
      ...
      {"DivisionName", ("DivisionName", "", "", false, false, true, false, "string")},  // System.String
      {"DivisionDesc", ("DivisionDesc", "", "", false, false, false, false, "string")},  // System.String
      {"EntrprsIdRef", ("EntrprsIdRef", "", "", false, false, true, false, "int32")},  // System.Int32
      {"EEntrprsName", ("EntrprsName", "Enterprise", "Enterprise", false, false, true, false, "string")},  // System.String
            };
    ...
    protected Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)> _M2cKeyfm =
        new Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)>() {
                    {("PhbkEnterpriseView", "Enterprise", "EntrprsId"), (true, "EntrprsIdRef")},
    }; 
    ...
    protected Dictionary<(string viewNm, string navNm, string propNm), string> _M2cfm = 
        ...
        {("PhbkEnterpriseView", "Enterprise", "EntrprsName"), "EEntrprsName"},
    };
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), object> getHiddenFilterByRow(IPhbkDivisionView rw, string nvNm) {
        ...
        foreach(string i in this._Values.Keys) {
            if(this.isInPrimkeyValue(i) || this.IsInUnkKeyValue(i)) {
                rslt[("PhbkDivisionView",nvNm,i)] = rw.GetType().GetProperty(i).GetValue(rw);
            }
        }
        return rslt;
    }
    ...
    protected  Dictionary<(string viewNm, string navNm, string propNm), string> _C2mfm = 
        new Dictionary<(string viewNm, string navNm, string propNm), string>() {
    {("LprDivision01View", "Division", "DivisionId"), "DivisionId"},
    {("LprDivision02View", "Division", "DivisionId"), "DivisionId"},
    {("PhbkEmployeeView", "Division", "DivisionIdRef"), "DivisionId"},
    {("LprEmployee02View", "Division", "DivisionIdRef"), "DivisionId"},
    };
    public Dictionary<(string viewNm, string navNm, string propNm), string> getC2mfm() {
        ...
        public async Task<IList<IPhbkDivisionView>> getall() {
            try
            {
                HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getall");
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return new List<IPhbkDivisionView>( JsonConvert.DeserializeObject<IList<PhbkDivisionView>>(responseBody) );
            } 
            catch(Exception e)
            {
                string exceptionMsg = "PhbkDivisionViewService.getall : " + e.Message;
        ...
        public async Task<IPhbkDivisionViewPage> getwithfilter(IPhbkDivisionViewFilter filter) {
            string prms = null;
            if(filter != null) {
                ...
                if (filter.EntrprsIdRef != null) {
                    foreach(var val in filter.EntrprsIdRef) {
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("entrprsIdRef") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms = "?" + Uri.EscapeDataString("entrprsIdRef") + "=" + Uri.EscapeDataString(val.ToString());
                            else 
                                //prms += "&" + Uri.EscapeDataString("entrprsIdRef") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms += "&" + Uri.EscapeDataString("entrprsIdRef") + "=" + Uri.EscapeDataString(val.ToString());
                ...
                if(filter.entrprsIdRefOprtr != null) {
                    foreach(var val in filter.entrprsIdRefOprtr) {
                        if(val != null) {
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("entrprsIdRefOprtr") + "[]=" +  Uri.EscapeDataString(val.ToString());
                                prms = "?" + Uri.EscapeDataString("entrprsIdRefOprtr") + "=" +  Uri.EscapeDataString(val.ToString());
                            else 
                                //prms += "&" + Uri.EscapeDataString("entrprsIdRefOprtr") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms += "&" + Uri.EscapeDataString("entrprsIdRefOprtr") + "=" + Uri.EscapeDataString(val.ToString());
                            ...
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("entrprsIdRefOprtr") + "[]=" +  Uri.EscapeDataString("eq");
                                prms = "?" + Uri.EscapeDataString("entrprsIdRefOprtr") + "=" +  Uri.EscapeDataString("eq");
                            else 
                                //prms += "&" + Uri.EscapeDataString("entrprsIdRefOprtr") + "[]=" + Uri.EscapeDataString("eq");
                                prms += "&" + Uri.EscapeDataString("entrprsIdRefOprtr") + "=" + Uri.EscapeDataString("eq");
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<PhbkDivisionViewPage>(responseBody) ;
            } 
            catch(Exception e)
            {
                string exceptionMsg = "PhbkDivisionViewService.getwithfilter : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    //    // handling value of type IPhbkDivisionView
    // },
    // error => {
    //    // handling error 
    // });
    // 
    public async Task<IPhbkDivisionView> getone(
        System.Int32 DivisionId 
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<PhbkDivisionView>(responseBody) ;
            } 
            catch(Exception e) 
            {
                string exceptionMsg = "PhbkDivisionViewService.getone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    public async Task<IPhbkDivisionViewPage> getmanybyrepprim(IPhbkDivisionViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.DivisionId != null) {
                    foreach(var val in filter.DivisionId) {
        ...
        {
            string exceptionMsg = "PhbkDivisionViewService.getmanybyrepprim : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<IPhbkDivisionView> updateone(IPhbkDivisionView item) {
            if(item == null) {
            ...
            {
                string exceptionMsg = "PhbkDivisionViewService.updateone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<IPhbkDivisionView> addone(IPhbkDivisionView item) {
            if(item == null) {
                appGlblSettings.ShowErrorMessage("http", "Input item is not defined");
                return null;
            }
            ...
            {
                string exceptionMsg = "PhbkDivisionViewService.addone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<IPhbkDivisionView> deleteone(System.Int32 DivisionId ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("divisionId") + "=" +  Uri.EscapeDataString(DivisionId.ToString());
                else 
            ...
            {
                string exceptionMsg = "PhbkDivisionViewService.deleteone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public IPhbkDivisionViewNotify CopyToModelNotify(IPhbkDivisionView  src, IPhbkDivisionViewNotify dest = null) {
            if(dest == null) dest = new PhbkDivisionViewNotify();
            if(src == null) return dest;
            dest.DivisionId = src.DivisionId;
            dest.DivisionName = src.DivisionName;
            dest.DivisionDesc = src.DivisionDesc;
            dest.EntrprsIdRef = src.EntrprsIdRef;
            dest.EEntrprsName = src.EEntrprsName;
            return dest;
        }
        public IPhbkDivisionView CopyToModel(IPhbkDivisionView  src, IPhbkDivisionView dest = null) {
            if(dest == null) dest = new PhbkDivisionView();
            if(src == null) return dest;
            dest.DivisionId = src.DivisionId;
            dest.DivisionName = src.DivisionName;
            dest.DivisionDesc = src.DivisionDesc;
        ...
        public IPhbkDivisionViewFilter GetFilter() {
            return new PhbkDivisionViewFilter();
        }

        public IList<IWebServiceFilterRsltInterface> Row2FilterRslt(IPhbkDivisionView r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
        ...
        public IList<IWebServiceFilterRsltInterface> RowPrim2FilterRslt(IPhbkDivisionView r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
            if (r == null) return rslt;
            foreach(string i in this._Values.Keys) {
        ...
        public IPhbkDivisionViewFilter FilterRslt2Filter(IWebServiceFilterRsltInterface e, IPhbkDivisionViewFilter dest) {
            IPhbkDivisionViewFilter flt = dest;
            if(dest is null) {
                flt = GetFilter();
            }
        ...
        public IPhbkDivisionViewFilter FilterRslt2Filter(IList<IWebServiceFilterRsltInterface> src, IPhbkDivisionViewFilter dest) {
            IPhbkDivisionViewFilter rslt = dest;
            if(dest is null) {
                rslt = GetFilter();
            }
