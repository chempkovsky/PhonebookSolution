...
namespace ModelServicesPrismModule.Phonebook.PhbkDivision.ViewModels {
    ...
    public class PhbkDivisionViewRlistViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkDivisionViewService FrmSrvPhbkDivisionView = null;
        public PhbkDivisionViewRlistViewModel(IPhbkDivisionViewService _FrmSrvPhbkDivisionView, 
        ...
        public void NavigateToDetailCommand(IPhbkDivisionView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
...
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprDivision01View
//
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprDivision02View
//
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkEmployeeViewRlistUserControlDivision", Caption="Employees: Division", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprEmployee02View
//
            };
        }
        ...
        public void SformAddItemCommand() {
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkDivisionViewRaddUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        public void SformUpdItemCommand(IPhbkDivisionView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if (!CanUpdate) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkDivisionViewRupdUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion

        #region SformDelItemCommand
        public void SformDelItemCommand(IPhbkDivisionView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if(!CanDelete) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpDivisionId", selected.DivisionId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkDivisionViewRdelUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        
        #region SformViewItemCommand
        public void SformViewItemCommand(IPhbkDivisionView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpDivisionId", selected.DivisionId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkDivisionViewRviewUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
...
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprDivision02View
//
                case "RowMIPhbkEmployeeViewRlistUserControlDivision":
                    NavigateToDetailCommand(arow, "PhbkEmployeeView", "Division", "PhbkEmployeeViewRlistUserControl");
                    break;
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprEmployee02View
