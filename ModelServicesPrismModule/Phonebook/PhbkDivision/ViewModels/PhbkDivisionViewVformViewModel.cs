...
namespace ModelServicesPrismModule.Phonebook.PhbkDivision.ViewModels {
    public class PhbkDivisionViewVformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public PhbkDivisionViewVformViewModel(IPhbkDivisionViewDatasource _rootDataSource,
        ...
        public async Task DorootDataSourceAfterPropsChanged(object sender) {
            await MainThread.InvokeOnMainThreadAsync(() => {
                ...
                this.PatchEEntrprsName(this.rootDataSource.getValue("EEntrprsName"));
            });
        }
        #endregion
