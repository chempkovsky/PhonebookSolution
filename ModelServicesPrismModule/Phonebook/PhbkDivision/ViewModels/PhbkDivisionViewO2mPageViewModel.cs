...
namespace ModelServicesPrismModule.Phonebook.PhbkDivision.ViewModels {
    ...
    public class PhbkDivisionViewO2mPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        ...
        public PhbkDivisionViewO2mPageViewModel(IPhbkDivisionViewService _FrmSrvPhbkDivisionView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
