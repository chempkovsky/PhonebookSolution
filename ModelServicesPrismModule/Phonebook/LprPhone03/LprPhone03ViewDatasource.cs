...
/*
    In the file of IModule-class of the project for the current service the following lines of code must be inserted:
        ...
        {
            ...
            containerRegistry.Register<ILprPhone03ViewDatasource, LprPhone03ViewDatasource>();
            ...
        }

*/
namespace ModelServicesPrismModule.Phonebook.LprPhone03 {
    public class LprPhone03ViewDatasource: ILprPhone03ViewDatasource
    {
        protected readonly string _CurrentViewName   = "LprPhone03View";
        ...
        protected ILprPhone03ViewService frmRootSrv;
        protected IAppGlblSettingsService appGlblSettings;

        public LprPhone03ViewDatasource(ILprPhone03ViewService frs,
        ...
        public bool Interface2Values(ILprPhone03View data, bool doNotify = true) {
            if(data == null) {
        ...
        public ILprPhone03View Values2Interface() {
            object locobjval;

            LprPhone03View rslt = new LprPhone03View(); 
        ...
        protected ILprPhone03ViewFilter DefineFilterOneProp(ILprPhone03ViewFilter flt, string propNm, object value, string Oprtr) {
            if(flt == null) flt = new LprPhone03ViewFilter(); 
        ...
        protected ILprPhone03ViewFilter GetFilterByCurrDirMstrs() {
            ILprPhone03ViewFilter flt = new LprPhone03ViewFilter(); 
            Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)> M2cKeyfm = this.frmRootSrv.getM2cKeyfm();
            foreach(var lkey in M2cKeyfm.Keys) {
                if (this.isSetValue(M2cKeyfm[lkey].propNm)) {
        ...
        public async Task<IList<ILprPhone03View>> GetClActionByCurrDirMstrs() {
            if (!this.IsSetFilterByCurrDirMstrs()) {
                return new List<ILprPhone03View>();
            }
            ILprPhone03ViewPage prslt = await this.frmRootSrv.getwithfilter(this.GetFilterByCurrDirMstrs());
            if(prslt == null) {
                return new List<ILprPhone03View>();
            }
            if(prslt.items == null) {
        ...
        public async Task<IList<ILprPhone03View>> GetClActionByFldFilter(string fldName, object fldVal) {
            ...
            ILprPhone03ViewFilter flt = this.GetFilterByCurrDirMstrs();
            this.DefineFilterOneProp(flt, fldName, fldVal, "lk");
            if (flt.orderby == null) flt.orderby = new List<string>();
            flt.orderby.Add(fldName);
            ILprPhone03ViewPage prslt = await this.frmRootSrv.getwithfilter(flt);
            if(prslt == null) {
                return new List<ILprPhone03View>();
            }
            if(prslt.items == null) {
        ...
        public async Task getone(
            ...
            ILprPhone03View data = await this.frmRootSrv.getone(
                  PhoneTypeIdRef
                , LpdPhoneIdRef
                , PhoneId
            );
        ...
        public async Task updateone() {
            ...
            ILprPhone03View itm = this.Values2Interface();
            ILprPhone03View data = await this.frmRootSrv.updateone(itm);
            if(data != null) {
        ...
        public async Task addone() {
            ...
            ILprPhone03View itm = this.Values2Interface();
            ILprPhone03View data = await this.frmRootSrv.addone(itm);
            if(data != null) {
                this.Interface2Values(data, false);
        ...
        public async Task deleteone() {
            ...
            ILprPhone03View data = await this.frmRootSrv.deleteone(  locPhoneTypeIdRef ,   locLpdPhoneIdRef ,   locPhoneId );
            if(data != null) {
                this.Interface2Values(data, false);
