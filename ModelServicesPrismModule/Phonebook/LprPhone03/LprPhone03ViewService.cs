...
/*
    In the file of IModule-class of the project for the current service the following lines of code must be inserted:
        ...
        {
            ...
            containerRegistry.Register<ILprPhone03ViewService, LprPhone03ViewService>();
            ...
        }

*/
namespace ModelServicesPrismModule.Phonebook.LprPhone03 {
    public class LprPhone03ViewService: ILprPhone03ViewService
    {
        ...
        public LprPhone03ViewService(IAppGlblSettingsService agstt) {
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), object> getHiddenFilterByRow(ILprPhone03View rw, string nvNm) {
        ...
        foreach(string i in this._Values.Keys) {
            if(this.isInPrimkeyValue(i) || this.IsInUnkKeyValue(i)) {
                rslt[("LprPhone03View",nvNm,i)] = rw.GetType().GetProperty(i).GetValue(rw);
            }
        }
        return rslt;
    }
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), string> getC2mfm() {
        ...
        public async Task<IList<ILprPhone03View>> getall() {
            try
            {
                HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getall");
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return new List<ILprPhone03View>( JsonConvert.DeserializeObject<IList<LprPhone03View>>(responseBody) );
            } 
            catch(Exception e)
            {
                string exceptionMsg = "LprPhone03ViewService.getall : " + e.Message;
        ...
        public async Task<ILprPhone03ViewPage> getwithfilter(ILprPhone03ViewFilter filter) {
            string prms = null;
            if(filter != null) {
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<LprPhone03ViewPage>(responseBody) ;
            } 
            catch(Exception e)
            {
                string exceptionMsg = "LprPhone03ViewService.getwithfilter : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    // });
    // 
    public async Task<ILprPhone03View> getone(
        ...
        , System.Int32 PhoneId 
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<LprPhone03View>(responseBody) ;
            } 
            catch(Exception e) 
            {
                string exceptionMsg = "LprPhone03ViewService.getone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    public async Task<ILprPhone03ViewPage> getmanybyrepprim(ILprPhone03ViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.PhoneId != null) {
                    foreach(var val in filter.PhoneId) {
        ...
        {
            string exceptionMsg = "LprPhone03ViewService.getmanybyrepprim : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILprPhone03View> updateone(ILprPhone03View item) {
            if(item == null) {
            ...
            {
                string exceptionMsg = "LprPhone03ViewService.updateone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILprPhone03View> addone(ILprPhone03View item) {
            if(item == null) {
                appGlblSettings.ShowErrorMessage("http", "Input item is not defined");
                return null;
            }
            ...
            {
                string exceptionMsg = "LprPhone03ViewService.addone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILprPhone03View> deleteone(System.Int32 PhoneTypeIdRef , System.Int32 LpdPhoneIdRef , System.Int32 PhoneId ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("phoneId") + "=" +  Uri.EscapeDataString(PhoneId.ToString());
                else 
            ...
            {
                string exceptionMsg = "LprPhone03ViewService.deleteone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public ILprPhone03ViewNotify CopyToModelNotify(ILprPhone03View  src, ILprPhone03ViewNotify dest = null) {
            if(dest == null) dest = new LprPhone03ViewNotify();
            if(src == null) return dest;
        ...
        public ILprPhone03View CopyToModel(ILprPhone03View  src, ILprPhone03View dest = null) {
            if(dest == null) dest = new LprPhone03View();
            if(src == null) return dest;
            dest.PhoneId = src.PhoneId;
            dest.LpdPhoneIdRef = src.LpdPhoneIdRef;
            dest.PhoneTypeIdRef = src.PhoneTypeIdRef;
        ...
        public ILprPhone03ViewFilter GetFilter() {
            return new LprPhone03ViewFilter();
        }

        public IList<IWebServiceFilterRsltInterface> Row2FilterRslt(ILprPhone03View r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
        ...
        public IList<IWebServiceFilterRsltInterface> RowPrim2FilterRslt(ILprPhone03View r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
            if (r == null) return rslt;
            foreach(string i in this._Values.Keys) {
        ...
        public ILprPhone03ViewFilter FilterRslt2Filter(IWebServiceFilterRsltInterface e, ILprPhone03ViewFilter dest) {
            ILprPhone03ViewFilter flt = dest;
            if(dest is null) {
                flt = GetFilter();
            }
        ...
        public ILprPhone03ViewFilter FilterRslt2Filter(IList<IWebServiceFilterRsltInterface> src, ILprPhone03ViewFilter dest) {
            ILprPhone03ViewFilter rslt = dest;
            if(dest is null) {
                rslt = GetFilter();
            }
