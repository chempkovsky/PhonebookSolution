...
namespace ModelServicesPrismModule.Phonebook.LprDivision01 {
    public class LprDivision01ViewDatasource: ILprDivision01ViewDatasource
    {
        protected readonly string _CurrentViewName   = "LprDivision01View";
        ...
        protected ILprDivision01ViewService frmRootSrv;
        protected IAppGlblSettingsService appGlblSettings;

        public LprDivision01ViewDatasource(ILprDivision01ViewService frs,
        ...
        public bool Interface2Values(ILprDivision01View data, bool doNotify = true) {
            if(data == null) {
        ...
        public ILprDivision01View Values2Interface() {
            object locobjval;

            LprDivision01View rslt = new LprDivision01View(); 
        ...
        protected ILprDivision01ViewFilter DefineFilterOneProp(ILprDivision01ViewFilter flt, string propNm, object value, string Oprtr) {
            if(flt == null) flt = new LprDivision01ViewFilter(); 
        ...
        protected ILprDivision01ViewFilter GetFilterByCurrDirMstrs() {
            ILprDivision01ViewFilter flt = new LprDivision01ViewFilter(); 
            Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)> M2cKeyfm = this.frmRootSrv.getM2cKeyfm();
            foreach(var lkey in M2cKeyfm.Keys) {
                if (this.isSetValue(M2cKeyfm[lkey].propNm)) {
        ...
        public async Task<IList<ILprDivision01View>> GetClActionByCurrDirMstrs() {
            if (!this.IsSetFilterByCurrDirMstrs()) {
                return new List<ILprDivision01View>();
            }
            ILprDivision01ViewPage prslt = await this.frmRootSrv.getwithfilter(this.GetFilterByCurrDirMstrs());
            if(prslt == null) {
                return new List<ILprDivision01View>();
            }
            if(prslt.items == null) {
        ...
        public async Task<IList<ILprDivision01View>> GetClActionByFldFilter(string fldName, object fldVal) {
            ...
            ILprDivision01ViewFilter flt = this.GetFilterByCurrDirMstrs();
            this.DefineFilterOneProp(flt, fldName, fldVal, "lk");
            if (flt.orderby == null) flt.orderby = new List<string>();
            flt.orderby.Add(fldName);
            ILprDivision01ViewPage prslt = await this.frmRootSrv.getwithfilter(flt);
            if(prslt == null) {
                return new List<ILprDivision01View>();
            }
            if(prslt.items == null) {
        ...
        public async Task getone(
            ...
            ILprDivision01View data = await this.frmRootSrv.getone(
                  DivisionNameIdRef
                , DivisionId
            );
            if(data != null) {
        ...
        public async Task updateone() {
            ...
            ILprDivision01View itm = this.Values2Interface();
            ILprDivision01View data = await this.frmRootSrv.updateone(itm);
            if(data != null) {
        ...
        public async Task addone() {
            ...
            ILprDivision01View itm = this.Values2Interface();
            ILprDivision01View data = await this.frmRootSrv.addone(itm);
            if(data != null) {
                this.Interface2Values(data, false);
        ...
        public async Task deleteone() {
            ...
            ILprDivision01View data = await this.frmRootSrv.deleteone(  locDivisionNameIdRef ,   locDivisionId );
            if(data != null) {
                this.Interface2Values(data, false);
