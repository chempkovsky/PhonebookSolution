...
/*
    In the file of IModule-class of the project for the current service the following lines of code must be inserted:
        ...
        {
            ...
            containerRegistry.Register<ILprDivision02ViewService, LprDivision02ViewService>();
            ...
        }

*/
namespace ModelServicesPrismModule.Phonebook.LprDivision02 {
    public class LprDivision02ViewService: ILprDivision02ViewService
    {
        ...
        public LprDivision02ViewService(IAppGlblSettingsService agstt) {
            this.appGlblSettings = agstt;
            this.serviceUrl = this.appGlblSettings.GetWebApiPrefix("LprDivision02View") + "lprdivision02viewwebapi";
      ...
      {"EntrprsIdRef", ("EntrprsIdRef", "", "", true, false, true, false, "int32")},  // System.Int32
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), object> getHiddenFilterByRow(ILprDivision02View rw, string nvNm) {
        ...
        foreach(string i in this._Values.Keys) {
            if(this.isInPrimkeyValue(i) || this.IsInUnkKeyValue(i)) {
                rslt[("LprDivision02View",nvNm,i)] = rw.GetType().GetProperty(i).GetValue(rw);
            }
        }
        return rslt;
    }
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), string> getC2mfm() {
        ...
        public async Task<IList<ILprDivision02View>> getall() {
            try
            {
                HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getall");
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return new List<ILprDivision02View>( JsonConvert.DeserializeObject<IList<LprDivision02View>>(responseBody) );
            } 
            catch(Exception e)
            {
                string exceptionMsg = "LprDivision02ViewService.getall : " + e.Message;
        ...
        public async Task<ILprDivision02ViewPage> getwithfilter(ILprDivision02ViewFilter filter) {
            string prms = null;
            if(filter != null) {
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<LprDivision02ViewPage>(responseBody) ;
            } 
            catch(Exception e)
            {
                string exceptionMsg = "LprDivision02ViewService.getwithfilter : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    //    // handling value of type ILprDivision02View
    // },
    // error => {
    //    // handling error 
    // });
    // 
    public async Task<ILprDivision02View> getone(
        ...
        , System.Int32 DivisionId 
            ...
            string prms = null;
                if(prms == null)
                    ...
                    prms += "&" + Uri.EscapeDataString("divisionId") + "=" + Uri.EscapeDataString(DivisionId.ToString());
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("entrprsIdRef") + "=" +  Uri.EscapeDataString(EntrprsIdRef.ToString());
                else 
                    prms += "&" + Uri.EscapeDataString("entrprsIdRef") + "=" + Uri.EscapeDataString(EntrprsIdRef.ToString());
                if(prms == null)
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<LprDivision02View>(responseBody) ;
            } 
            catch(Exception e) 
            {
                string exceptionMsg = "LprDivision02ViewService.getone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    public async Task<ILprDivision02ViewPage> getmanybyrepprim(ILprDivision02ViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.DivisionId != null) {
                    foreach(var val in filter.DivisionId) {
        ...
        {
            string exceptionMsg = "LprDivision02ViewService.getmanybyrepprim : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILprDivision02View> updateone(ILprDivision02View item) {
            if(item == null) {
            ...
            {
                string exceptionMsg = "LprDivision02ViewService.updateone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILprDivision02View> addone(ILprDivision02View item) {
            if(item == null) {
                appGlblSettings.ShowErrorMessage("http", "Input item is not defined");
                return null;
            }
            ...
            {
                string exceptionMsg = "LprDivision02ViewService.addone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<ILprDivision02View> deleteone(System.Int32 EntrprsIdRef , System.Int32 DivisionNameIdRef , System.Int32 DivisionId ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("divisionId") + "=" +  Uri.EscapeDataString(DivisionId.ToString());
                else 
            ...
            {
                string exceptionMsg = "LprDivision02ViewService.deleteone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public ILprDivision02ViewNotify CopyToModelNotify(ILprDivision02View  src, ILprDivision02ViewNotify dest = null) {
            if(dest == null) dest = new LprDivision02ViewNotify();
            if(src == null) return dest;
        ...
        public ILprDivision02View CopyToModel(ILprDivision02View  src, ILprDivision02View dest = null) {
            if(dest == null) dest = new LprDivision02View();
            if(src == null) return dest;
            dest.DivisionId = src.DivisionId;
            dest.EntrprsIdRef = src.EntrprsIdRef;
            dest.DivisionNameIdRef = src.DivisionNameIdRef;
        ...
        public ILprDivision02ViewFilter GetFilter() {
            return new LprDivision02ViewFilter();
        }

        public IList<IWebServiceFilterRsltInterface> Row2FilterRslt(ILprDivision02View r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
        ...
        public IList<IWebServiceFilterRsltInterface> RowPrim2FilterRslt(ILprDivision02View r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
            if (r == null) return rslt;
            foreach(string i in this._Values.Keys) {
        ...
        public ILprDivision02ViewFilter FilterRslt2Filter(IWebServiceFilterRsltInterface e, ILprDivision02ViewFilter dest) {
            ILprDivision02ViewFilter flt = dest;
            if(dest is null) {
                flt = GetFilter();
            }
        ...
        public ILprDivision02ViewFilter FilterRslt2Filter(IList<IWebServiceFilterRsltInterface> src, ILprDivision02ViewFilter dest) {
            ILprDivision02ViewFilter rslt = dest;
            if(dest is null) {
                rslt = GetFilter();
            }
