...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.Views {
    /// <summary>
    /// Interaction logic for PhbkEnterpriseViewRdelPage.xaml
    /// </summary>
    public partial class PhbkEnterpriseViewRdelPage: ContentPage, IDestructible
    {
        public PhbkEnterpriseViewRdelPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEnterpriseViewRdelPage inst = d as PhbkEnterpriseViewRdelPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEnterpriseViewRdelPage),
