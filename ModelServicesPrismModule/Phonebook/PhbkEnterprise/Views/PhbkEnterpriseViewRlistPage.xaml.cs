...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.Views {
    /// <summary>
    /// Interaction logic for PhbkEnterpriseViewRlistPage.xaml
    /// </summary>
    public partial class PhbkEnterpriseViewRlistPage: ContentPage, IDestructible 
    {
        public PhbkEnterpriseViewRlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEnterpriseViewRlistPage inst = d as PhbkEnterpriseViewRlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEnterpriseViewRlistPage),
