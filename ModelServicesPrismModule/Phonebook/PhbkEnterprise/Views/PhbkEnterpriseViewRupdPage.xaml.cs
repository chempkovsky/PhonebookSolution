...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.Views {
    /// <summary>
    /// Interaction logic for PhbkEnterpriseViewRupdPage.xaml
    /// </summary>
    public partial class PhbkEnterpriseViewRupdPage: ContentPage, IDestructible
    {
        public PhbkEnterpriseViewRupdPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEnterpriseViewRupdPage inst = d as PhbkEnterpriseViewRupdPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEnterpriseViewRupdPage),
