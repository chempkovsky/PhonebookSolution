...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.Views {
    /// <summary>
    /// Interaction logic for PhbkEnterpriseViewRaddPage.xaml
    /// </summary>
    public partial class PhbkEnterpriseViewRaddPage: ContentPage, IDestructible
    {
        public PhbkEnterpriseViewRaddPage()
        {
            InitializeComponent();
        }
        ...
        {
            PhbkEnterpriseViewRaddPage inst = d as PhbkEnterpriseViewRaddPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(PhbkEnterpriseViewRaddPage),
