...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    ...
    public class PhbkEnterpriseViewRdlistViewModel: RegionAwareViewModelBase, IRegionAware
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkEnterpriseViewService FrmSrvPhbkEnterpriseView = null;
        
        public PhbkEnterpriseViewRdlistViewModel(IPhbkEnterpriseViewService _FrmSrvPhbkEnterpriseView, IAppGlblSettingsService GlblSettingsSrv) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkDivisionViewRdlistUserControlEnterprise", Caption="Divisions: Enterprise", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
//  "02016-RdlistUserControl.xaml.cs" type has not been generated for LprDivision02View
//
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                case "RowMIPhbkDivisionViewRdlistUserControlEnterprise":
                    NavigateToDetailCommand(arow, "PhbkDivisionView", "Enterprise", "PhbkDivisionViewRdlistUserControl");
                    break;
//
//  Warning:
//  "02016-RdlistUserControl.xaml.cs" type has not been generated for LprDivision02View
