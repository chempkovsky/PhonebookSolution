...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    ...
    public class PhbkEnterpriseViewRlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkEnterpriseViewService FrmSrvPhbkEnterpriseView = null;
        protected INavigationService _navigationService;
        public PhbkEnterpriseViewRlistPageViewModel(IPhbkEnterpriseViewService _FrmSrvPhbkEnterpriseView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                ...
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkDivisionViewRlistPageEnterprise", Caption="Divisions: Enterprise", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
...
//
        ...
        public async Task NavigateToDetailCommand(IPhbkEnterpriseView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
            if(IsDestroyed) return;
        ...
        public async Task SformAddItemCommand() {
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEnterpriseViewRaddPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
        ...
        public async Task SformUpdItemCommand(IPhbkEnterpriseView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEnterpriseViewRupdPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformDelItemCommand
        public async Task SformDelItemCommand(IPhbkEnterpriseView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            navigationParameters.Add("pkpEntrprsId", selected.EntrprsId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEnterpriseViewRdelPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformViewItemCommand
        public async Task SformViewItemCommand(IPhbkEnterpriseView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpEntrprsId", selected.EntrprsId);
            INavigationResult nr2 = await _navigationService.NavigateAsync("PhbkEnterpriseViewRviewPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
        ...
        protected async void RowMenuItemsCommandExecute(object prm)
        {
            ...
            switch(mi.Id) {
                ...
                case "RowMIPhbkDivisionViewRlistPageEnterprise":
                    await NavigateToDetailCommand(arow, "PhbkDivisionView", "Enterprise", "PhbkDivisionViewRlistPage");
                    break;
//
//  Warning:
//  "01917-RlistPage.xaml.cs" type has not been generated for LprDivision02View
