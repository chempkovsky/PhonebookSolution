...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    public class PhbkEnterpriseViewRaddPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public PhbkEnterpriseViewRaddPageViewModel(IPhbkEnterpriseViewService _FrmSrvPhbkEnterpriseView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                Caption = "Add item for Enterprise";
                if (resetHF) { HiddenFilters = hf; }
                FormControlModel = FrmSrvPhbkEnterpriseView.CopyToModelNotify(null,null); // this is correct: cleanup twice
                EformMode = EformModeEnum.AddMode;
                FormControlModel = null; // since DateTime-issue this is correct: FrmSrvPhbkEnterpriseView.CopyToModelNotify(null,null);
                IsParentLoaded = true;
        }
        #endregion
