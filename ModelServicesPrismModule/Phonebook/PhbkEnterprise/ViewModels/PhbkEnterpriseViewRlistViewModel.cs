...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    ...
    public class PhbkEnterpriseViewRlistViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkEnterpriseViewService FrmSrvPhbkEnterpriseView = null;
        public PhbkEnterpriseViewRlistViewModel(IPhbkEnterpriseViewService _FrmSrvPhbkEnterpriseView, 
        ...
        public void NavigateToDetailCommand(IPhbkEnterpriseView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
            ...
            navigationParameters.Add("HiddenFilter", this.FrmSrvPhbkEnterpriseView.getHiddenFilterByRow(selected, fkNvNm));  
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                ...
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkDivisionViewRlistUserControlEnterprise", Caption="Divisions: Enterprise", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprDivision02View
//
            };
        }
        ...
        public void SformAddItemCommand() {
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEnterpriseViewRaddUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        public void SformUpdItemCommand(IPhbkEnterpriseView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if (!CanUpdate) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpEntrprsId", selected.EntrprsId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEnterpriseViewRupdUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion

        #region SformDelItemCommand
        public void SformDelItemCommand(IPhbkEnterpriseView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if(!CanDelete) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpEntrprsId", selected.EntrprsId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEnterpriseViewRdelUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        
        #region SformViewItemCommand
        public void SformViewItemCommand(IPhbkEnterpriseView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpEntrprsId", selected.EntrprsId);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("PhbkEnterpriseViewRviewUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            IWebServiceFilterMenuInterface mi = prm as IWebServiceFilterMenuInterface;
            if (mi == null) return;
            IPhbkEnterpriseView arow = mi.FeedbackData as IPhbkEnterpriseView;
            if (arow == null) return;
            switch(mi.Id) {
                case "RowUpdMI":
                ...
                case "RowMIPhbkDivisionViewRlistUserControlEnterprise":
                    NavigateToDetailCommand(arow, "PhbkDivisionView", "Enterprise", "PhbkDivisionViewRlistUserControl");
                    break;
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprDivision02View
        ...
        protected bool RowMenuItemsCommandCanExecute(object prm)
        {
            ...
            if (mi != null) {
                switch(mi.Id) {
                    ...
                    case "RowMIPhbkDivisionViewRlistUserControlEnterprise":
                        return ((GlblSettingsSrv.GetViewModelMask("PhbkDivisionView") & 1) == 1);
//
//  Warning:
//  "01916-RlistUserControl.xaml.cs" type has not been generated for LprDivision02View
//
       ...
       public async void OnNavigatedTo(INavigationContext navigationContext) {
            ...
            if ((PermissionMask & 1) != 1) {
                if (navigationContext.NavigationService.Journal.CurrentEntry.Uri.OriginalString == "AccessDeniedUserControl")
                {
                    ...
                    throw new Exception("Access Denied to navigate PhbkEnterpriseView");
                } else {
            ...
            if ((!IsParentLoaded) || (IsNavigatedBack)) {
                ...
                if(prms.ContainsKey("HiddenFilter")) {
                    IList<IWebServiceFilterRsltInterface> hflts = 
                        FrmSrvPhbkEnterpriseView.getHiddenFilterAsFltRslt(
            ...
            if (prms.ContainsKey("EformModeEnum")) {
                ...
                if ((mode == EformModeEnum.AddMode) || (mode == EformModeEnum.UpdateMode)) {
                    ...
                    IPhbkEnterpriseView data = FrmSrvPhbkEnterpriseView.CopyToModel(null,null);
                    data.EntrprsId = pkpEntrprsId;
