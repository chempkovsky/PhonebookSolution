...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    public class PhbkEnterpriseViewSformViewModel: INotifyPropertyChanged, ISformViewModelInterface, IBindingContextChanged, IDestructible
    {
        protected IPhbkEnterpriseViewService FrmRootSrv=null;
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IDialogService _dialogService=null;
    

        bool CnFllscn = false;
        public PhbkEnterpriseViewSformViewModel(IAppGlblSettingsService GlblSettingsSrv, IPhbkEnterpriseViewService FrmRootSrv, 
            ...
            CnFllscn = (GlblSettingsSrv.GetViewModelMask("PhbkEnterpriseView") & 16) == 16;
        }
        ...
        #region DataSource
        protected IEnumerable<IPhbkEnterpriseView> _DataSource = new ObservableCollection<IPhbkEnterpriseView>();
        public IEnumerable<IPhbkEnterpriseView> DataSource
        { 
            get
            {
                return _DataSource;
        ...
        protected IEnumerable<IColumnSelectorItemDefInterface> _SelectedColumns = new ObservableCollection<IColumnSelectorItemDefInterface>() {
            ...
            new ColumnSelectorItemDefViewModel() {
                Name= "EntrprsDesc", 
                Caption= "Description of the Enterprise", 
                IsChecked= false
            }, 
        };
        ...
        public async Task HiddenFiltersPropertyChanged(object Sender, object OldValue, object NewValue)
        {
            ...
            ObservableCollection<IWebServiceFilterDefInterface> fltDf = 
                new ObservableCollection<IWebServiceFilterDefInterface>() {
                    new WebServiceFilterDefViewModel() {fltrName="EntrprsId", fltrCaption="Id of the Enterprise",  fltrDataType="int32", fltrMaxLen=null, fltrMin=null, fltrMax=null },
                    new WebServiceFilterDefViewModel() {fltrName="EntrprsName", fltrCaption="Name of the Enterprise",  fltrDataType="string", fltrMaxLen=20, fltrMin=null, fltrMax=null },
                };
            ActualCurrentPage = 0;
            defineSearchMethod();
            await onFilter();
        ...
        protected async Task onFilter() {
            ...
            if(SearchMethod == "NoSearchMethod") {
                ClearDataSource();
                DataSource = new ObservableCollection<IPhbkEnterpriseView>();
                SelectedRow = null;
                IsInQuery = false;
                return;
            }
            ...
            if ((SearchMethod == "FullScan")
                || (SearchMethod == "ScanByUkEntrprsNameUK")
                || (SearchMethod == "ScanByUkPrimary")
            ) {

                IPhbkEnterpriseViewFilter flt  = FrmRootSrv.GetFilter();
                ...
                IPhbkEnterpriseViewPage rslt = await this.FrmRootSrv.getwithfilter(flt);
                if(rslt != null) {
                    ...
                    SelectedRow = null;
                    ObservableCollection<IPhbkEnterpriseView> ds = DataSource as ObservableCollection<IPhbkEnterpriseView>;
                    IsDsDestroyed = true;
                    if (ds == null) { ds = new ObservableCollection<IPhbkEnterpriseView>(); } else { ds.Clear(); }
                    IsDsDestroyed = false;
                    DataSource = null; 
                    if(rslt.items != null) {
                        foreach(IPhbkEnterpriseView itm in rslt.items) {
        ...
        public void SformAfterAddItemCommand(object sender, object item) {
            IPhbkEnterpriseView prm = item as  IPhbkEnterpriseView;
            if(prm == null) return;
            ObservableCollection<IPhbkEnterpriseView> ds = DataSource as ObservableCollection<IPhbkEnterpriseView>;
        ...
        public void SformAfterUpdItemCommand(object sender, object item) {
            ...
            IPhbkEnterpriseView rw = ds.Where(d => 
                        (d.EntrprsId == prm.EntrprsId)
                    ).FirstOrDefault();
            if (rw != null) {
        ...
        #region ScanByUkEntrprsNameUKFilterDefinitions
        protected IList<IUniqServiceFilterDefInterface> _ScanByUkEntrprsNameUKFilterDefinitions =
            new List<IUniqServiceFilterDefInterface>() {
                new UniqServiceFilterDef() { fltrName = "EntrprsName", fltrDispMemb = "EntrprsName", fltrTextMemb = "EntrprsName", fltrCaption = "Name of the Enterprise", fltrDataType = "string", fltrMaxLen = 20, fltrMin = null, fltrMax = null },
            };
        public IList<IUniqServiceFilterDefInterface> ScanByUkEntrprsNameUKFilterDefinitions {
            get {
                return _ScanByUkEntrprsNameUKFilterDefinitions;
            }
        }

        protected IPhbkEnterpriseView _ScanByUkEntrprsNameUKEntrprsNameItem = null;
        public IPhbkEnterpriseView ScanByUkEntrprsNameUKEntrprsNameItem {
            get {
                return _ScanByUkEntrprsNameUKEntrprsNameItem;
            }
            set {
                if (_ScanByUkEntrprsNameUKEntrprsNameItem != value) {
                    _ScanByUkEntrprsNameUKEntrprsNameItem = value;
                    OnPropertyChanged();
                    OnPropertyChanged("ScanByUkEntrprsNameUKEntrprsNameText");
                }
            }
        }
        
        protected IList<IPhbkEnterpriseView> _ScanByUkEntrprsNameUKItemsSource = null;
        public IList<IPhbkEnterpriseView> ScanByUkEntrprsNameUKItemsSource {
            get {
                return _ScanByUkEntrprsNameUKItemsSource;
            }
            set {
                if(_ScanByUkEntrprsNameUKItemsSource != value) {
                    _ScanByUkEntrprsNameUKItemsSource = value;
                    OnPropertyChanged();
                }
            }
        }

        protected string _ScanByUkEntrprsNameUKEntrprsNameText = null;
        public string ScanByUkEntrprsNameUKEntrprsNameText {
            get {
                IPhbkEnterpriseView dmObj = ScanByUkEntrprsNameUKEntrprsNameItem;
                if(dmObj != null) {
                    return dmObj.EntrprsName;
                } else {
                    return _ScanByUkEntrprsNameUKEntrprsNameText;
                }

            }
            set {
                if(_ScanByUkEntrprsNameUKEntrprsNameText != value) {
                    _ScanByUkEntrprsNameUKEntrprsNameText = value;
                    OnPropertyChanged();
                }
            }
        }
        protected ICommand _ScanByUkEntrprsNameUKTextChangedCommand = null;
        public ICommand ScanByUkEntrprsNameUKTextChangedCommand
        {
            get
            {
                return _ScanByUkEntrprsNameUKTextChangedCommand ?? (_ScanByUkEntrprsNameUKTextChangedCommand = new Command((prm) => ScanByUkEntrprsNameUKTextChangedCommandExecute(prm), (prm) => ScanByUkEntrprsNameUKTextChangedCommandCanExecute(prm)));
            }
        }
        // Reason: UserInput = 0, ProgrammaticChange = 1, SuggestionChosen = 2
        protected async void ScanByUkEntrprsNameUKTextChangedCommandExecute(object prm)
        {
            ...
            IPhbkEnterpriseView itm = null;
            IPhbkEnterpriseViewFilter fltr = FrmRootSrv.GetFilter();
            fltr.page = 0;
            fltr.pagesize = 15;
            bool runQuery = true;
            itm = ScanByUkEntrprsNameUKEntrprsNameItem;
            if (k > 0)  { 
                if(itm is null) {
                    runQuery = false;
                } else {
                    fltr.EntrprsName = new List<System.String>() { itm.EntrprsName }; 
                    fltr.entrprsNameOprtr = new List<string>() { "eq" };
                }
             } else if(k == 0) { 
                ScanByUkEntrprsNameUKEntrprsNameItem = null;
                ScanByUkEntrprsNameUKEntrprsNameText = tprm.QueryText;
                    fltr.EntrprsName = new List<string>() { tprm.QueryText };
                fltr.entrprsNameOprtr = new List<string>() { "lk" };
             }
            if (runQuery) {
                IPhbkEnterpriseViewPage rslt = await FrmRootSrv.getmanybyrepunqEntrprsNameUK(fltr);
                if(rslt is null) {
                    ScanByUkEntrprsNameUKItemsSource = null;
                } else {
                    ScanByUkEntrprsNameUKItemsSource = rslt.items;
                }
            } else {
                ScanByUkEntrprsNameUKItemsSource = null;
            }
        }
        protected bool ScanByUkEntrprsNameUKTextChangedCommandCanExecute(object prm)
        {
            return true;
        }
        protected ICommand _ScanByUkEntrprsNameUKQuerySubmitted = null;
        public ICommand ScanByUkEntrprsNameUKQuerySubmitted
        {
            get
            {
                return _ScanByUkEntrprsNameUKQuerySubmitted ?? (_ScanByUkEntrprsNameUKQuerySubmitted = new Command((prm) => ScanByUkEntrprsNameUKQuerySubmittedExecute(prm), (prm) => ScanByUkEntrprsNameUKQuerySubmittedCanExecute(prm)));
            }
        }
        protected void ScanByUkEntrprsNameUKQuerySubmittedExecute(object prm)
        {
            if ((IsDsDestroyed) || (prm is null)) return;
            ...
            switch(tprm.FltDef.fltrName) {
                case "EntrprsName":
                    ScanByUkEntrprsNameUKEntrprsNameItem = tprm.ChosenSuggestion as IPhbkEnterpriseView;
                    break;
                default:
                    return;
            }
        ...
        protected bool ScanByUkEntrprsNameUKQuerySubmittedCanExecute(object prm) {
            return true;
        }
        protected ICommand _ScanByUkEntrprsNameUKUnfocusedCommand = null;
        public ICommand ScanByUkEntrprsNameUKUnfocusedCommand
        {
            get
            {
                return _ScanByUkEntrprsNameUKUnfocusedCommand ?? (_ScanByUkEntrprsNameUKUnfocusedCommand = new Command((prm) => ScanByUkEntrprsNameUKUnfocusedCommandExecute(prm), (prm) => ScanByUkEntrprsNameUKUnfocusedCommandCanExecute(prm)));
            }
        }
        protected void ScanByUkEntrprsNameUKUnfocusedCommandExecute(object prm)
        {
            if ((IsDsDestroyed) || (prm is null)) return;
            ScanByUkEntrprsNameUKItemsSource = null;
        }
        protected bool ScanByUkEntrprsNameUKUnfocusedCommandCanExecute(object prm) {
            return true;
        }
        #endregion
        ...
        protected IList<IUniqServiceFilterDefInterface> _ScanByUkPrimaryFilterDefinitions =
            new List<IUniqServiceFilterDefInterface>() {
                new UniqServiceFilterDef() { fltrName = "EntrprsId", fltrDispMemb = "EntrprsId", fltrTextMemb = "EntrprsId", fltrCaption = "Id of the Enterprise", fltrDataType = "int32", fltrMaxLen = null, fltrMin = null, fltrMax = null },
            };
        ...
        protected IPhbkEnterpriseView _ScanByUkPrimaryEntrprsIdItem = null;
        public IPhbkEnterpriseView ScanByUkPrimaryEntrprsIdItem {
            get {
                return _ScanByUkPrimaryEntrprsIdItem;
            }
            set {
                if (_ScanByUkPrimaryEntrprsIdItem != value) {
                    _ScanByUkPrimaryEntrprsIdItem = value;
                    OnPropertyChanged();
                    OnPropertyChanged("ScanByUkPrimaryEntrprsIdText");
                }
            }
        }
        
        protected IList<IPhbkEnterpriseView> _ScanByUkPrimaryItemsSource = null;
        public IList<IPhbkEnterpriseView> ScanByUkPrimaryItemsSource {
            get {
        ...
        protected string _ScanByUkPrimaryEntrprsIdText = null;
        public string ScanByUkPrimaryEntrprsIdText {
            get {
                IPhbkEnterpriseView dmObj = ScanByUkPrimaryEntrprsIdItem;
                if(dmObj != null) {
                    return dmObj.EntrprsId.ToString();
                } else {
                    return _ScanByUkPrimaryEntrprsIdText;
                }

            }
            set {
                if(_ScanByUkPrimaryEntrprsIdText != value) {
                    _ScanByUkPrimaryEntrprsIdText = value;
                    OnPropertyChanged();
                }
            }
        }
        ...
        protected async void ScanByUkPrimaryTextChangedCommandExecute(object prm)
        {
            ...
            fltr.pagesize = 15;
            bool runQuery = true;
            itm = ScanByUkPrimaryEntrprsIdItem;
            if (k > 0)  { 
                if(itm is null) {
                    runQuery = false;
                } else {
                    fltr.EntrprsId = new List<System.Int32>() { itm.EntrprsId }; 
                    fltr.entrprsIdOprtr = new List<string>() { "eq" };
                }
             } else if(k == 0) { 
                ScanByUkPrimaryEntrprsIdItem = null;
                ScanByUkPrimaryEntrprsIdText = tprm.QueryText;
                {
                    System.Int32 val;
                    if (System.Int32.TryParse(tprm.QueryText, out val)) {
                        fltr.EntrprsId = new List<System.Int32>() { val };
                    }
                }
                fltr.entrprsIdOprtr = new List<string>() { "lk" };
             }
            if (runQuery) {
                IPhbkEnterpriseViewPage rslt = await FrmRootSrv.getmanybyrepprim(fltr);
                if(rslt is null) {
        ...
        protected void ScanByUkPrimaryQuerySubmittedExecute(object prm)
        {
            ...
            switch(tprm.FltDef.fltrName) {
                case "EntrprsId":
                    ScanByUkPrimaryEntrprsIdItem = tprm.ChosenSuggestion as IPhbkEnterpriseView;
                    break;
                default:
                    return;
            }
        ...
        public IList<IWebServiceFilterMenuInterface> defineSearchMethodMenuItemsData() {
            ...
            if(hasNtExternal) {
                ...
                if(this.HiddenFiltersVM.Count() == reqFkPrps.Count) {
                    ...
                    if(insmi) {
                        rslt.Add( 
                            new WebServiceFilterMenuViewModel() { Id = "ScanByUkEntrprsNameUK", Caption="filter by EntrprsNameUK", IconName=IconFont.Refresh, IconColor=Color.Default, Enabled=true, Data=null, Command = TableMenuItemsCommand}
                        );
                    }
                }
            }
