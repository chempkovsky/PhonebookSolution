...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    public class PhbkEnterpriseViewAformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        public System.Int32 ? EntrprsId {
            ...
            set { 
                if((_EntrprsId != value)||(value == null)) { 
                    ...
                    OnPropertyChanged();
                    ValidateField(value);
                    this.rootDataSource.setValue("EntrprsId", value);
                } 
            }
        }
        ...
        public System.String EntrprsName {
            ...
            set { 
                if((_EntrprsName != value)||(value == null)) { 
                    ...
                    OnPropertyChanged();
                    ValidateField(value);
                    this.rootDataSource.setValue("EntrprsName", value);
                } 
            }
        }
        ...
        public System.String EntrprsDesc {
            ...
            set { 
                if((_EntrprsDesc != value)||(value == null)) { 
                    ...
                    OnPropertyChanged();
                    ValidateField(value);
                    this.rootDataSource.setValue("EntrprsDesc", value);
                } 
            }
        }
        ...
        #region Constructor
        public PhbkEnterpriseViewAformViewModel(IPhbkEnterpriseViewDatasource _rootDataSource,
