...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    public class PhbkEnterpriseViewRupdPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public PhbkEnterpriseViewRupdPageViewModel(IPhbkEnterpriseViewService _FrmSrvPhbkEnterpriseView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
