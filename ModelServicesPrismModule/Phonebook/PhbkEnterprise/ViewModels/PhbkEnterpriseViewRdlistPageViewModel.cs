...
namespace ModelServicesPrismModule.Phonebook.PhbkEnterprise.ViewModels {
    ...
    public class PhbkEnterpriseViewRdlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IPhbkEnterpriseViewService FrmSrvPhbkEnterpriseView = null;
        protected INavigationService _navigationService;
        public PhbkEnterpriseViewRdlistPageViewModel(IPhbkEnterpriseViewService _FrmSrvPhbkEnterpriseView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIPhbkDivisionViewRdlistPageEnterprise", Caption="Divisions: Enterprise", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null},
//
//  Warning:
...
//
        ...
        protected async void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                case "RowMIPhbkDivisionViewRdlistPageEnterprise":
                    await NavigateToDetailCommand(arow, "PhbkDivisionView", "Enterprise", "PhbkDivisionViewRdlistPage");
                    break;
//
//  Warning:
//  "02017-RdlistPage.xaml.cs" type has not been generated for LprDivision02View
