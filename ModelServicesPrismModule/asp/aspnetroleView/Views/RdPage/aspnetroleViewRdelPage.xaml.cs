...
namespace ModelServicesPrismModule.asp.aspnetroleView.Views.RdPage {
    /// <summary>
    /// Interaction logic for AspnetroleViewRdelPage.xaml
    /// </summary>
    public partial class AspnetroleViewRdelPage: ContentPage, IDestructible
    {
        public AspnetroleViewRdelPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetroleViewRdelPage inst = d as AspnetroleViewRdelPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
