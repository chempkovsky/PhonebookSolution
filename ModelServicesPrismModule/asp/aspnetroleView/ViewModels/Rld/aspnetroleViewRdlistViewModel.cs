...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.Rld {

    public class AspnetroleViewRdlistViewModel: RegionAwareViewModelBase, IRegionAware
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetroleViewService FrmSrvaspnetroleView = null;
        
        public AspnetroleViewRdlistViewModel(IAspnetroleViewService _FrmSrvaspnetroleView, IAppGlblSettingsService GlblSettingsSrv) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetrolemaskViewRdlistUserControlAspNetRole", Caption="Role Masks: AspNetRole", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                    case "RowMIAspnetrolemaskViewRdlistUserControlAspNetRole":
                        NavigateToDetailCommand(arow, "aspnetrolemaskView", "AspNetRole", "AspnetrolemaskViewRdlistUserControl");
                        break;
                default:
                    break;
            }         
