...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.Dform {
    public class AspnetroleViewDformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetroleViewDformViewModel(IAspnetroleViewDatasource _rootDataSource,
