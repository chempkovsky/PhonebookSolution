...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.RlPage {
    ...
    public class AspnetroleViewRlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        ...
        public AspnetroleViewRlistPageViewModel(IRegionManager _regionManager, IAspnetroleViewService _FrmSrvaspnetroleView, 
       ...
       public void OnNavigatedTo(INavigationParameters prms) {
        ...
        ObservableCollection<IO2mListItemInterface> getDetailsList() {
            ObservableCollection<IO2mListItemInterface> rslt = new ObservableCollection<IO2mListItemInterface>() {
                ...
                if((GlblSettingsSrv.GetViewModelMask("aspnetrolemaskView") & 1) == 1)
                    rslt.Add(new O2mListItemViewModel() {Caption = "Role Masks: AspNetRole", ForeignKeyDetails = "AspNetRole",  Region = "AspnetrolemaskViewRlistUserControl" });
            return rslt;
        }
        #endregion
        ...
        public void NavigateToO2m() {
            ...
            var rgn = regionManager.Regions["AspnetroleViewRlistPageDetailRegion"];
            if(rgn != null) {
            ...
            regionManager.RequestNavigate("AspnetroleViewRlistPageDetailRegion", SelectedDetailsListItem.Region, OnRegionNavigationResult, navigationParameters);
        }
        #endregion
