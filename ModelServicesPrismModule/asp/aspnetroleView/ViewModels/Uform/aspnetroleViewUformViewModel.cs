...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.Uform {
    public class AspnetroleViewUformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetroleViewUformViewModel(IAspnetroleViewDatasource _rootDataSource,
