...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.RldPage {

    public class AspnetroleViewRdlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetrolemaskViewRdlistPageAspNetRole", Caption="Role Masks: AspNetRole", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        protected async void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                    case "RowMIAspnetrolemaskViewRdlistPageAspNetRole":
                        await NavigateToDetailCommand(arow, "aspnetrolemaskView", "AspNetRole", "AspnetrolemaskViewRdlistPage");
                        break;
                default:
                    break;
            }         
