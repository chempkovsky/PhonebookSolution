...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.O2mPage {

    public class AspnetroleViewO2mPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetroleViewService FrmRootSrvaspnetroleView = null;
        protected INavigationService _navigationService;
        protected IAspnetrolemaskViewService FrmSrvaspnetrolemaskView = null;
        public AspnetroleViewO2mPageViewModel(IAspnetroleViewService _FrmRootSrvaspnetroleView, 
            ...
            this.FrmRootSrvaspnetroleView = _FrmRootSrvaspnetroleView;
       ...
       public async void OnNavigatedTo(INavigationParameters prms) {
        ...
        ObservableCollection<IO2mListItemInterface> _DetailsList = new ObservableCollection<IO2mListItemInterface>() {
            new O2mListItemViewModel() {Caption = "Role Masks: AspNetRole", ForeignKeyDetails = "AspnetrolemaskViewLformUserControl:AspNetRole",  Region = "AspnetrolemaskViewLformUserControlDetailRegion" },
        };
        ...
        protected void DefineHiddenDetailFilter() {
            ...
            IAspnetroleView  selectedMasterRow  = SelectedRow as IAspnetroleView;
            if((SelectedDetailsListItem != null) && (selectedMasterRow != null)) {
                switch(SelectedDetailsListItem.ForeignKeyDetails) {
                    case "AspnetrolemaskViewLformUserControl:AspNetRole":
                        PermissionMaskDetail = GlblSettingsSrv.GetViewModelMask("aspnetrolemaskView");
                        tmpFlt = this.FrmSrvaspnetrolemaskView.getHiddenFilterAsFltRslt(this.FrmRootSrvaspnetroleView.getHiddenFilterByRow(selectedMasterRow, "AspNetRole"));
                        break;
                    default:
                        break;
                }
