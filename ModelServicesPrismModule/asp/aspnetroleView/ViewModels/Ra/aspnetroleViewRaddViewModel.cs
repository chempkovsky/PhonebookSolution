...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.Ra {
    public class AspnetroleViewRaddViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetroleViewService FrmSrvaspnetroleView = null;

        public AspnetroleViewRaddViewModel(IAspnetroleViewService _FrmSrvaspnetroleView, IAppGlblSettingsService GlblSettingsSrv) {
