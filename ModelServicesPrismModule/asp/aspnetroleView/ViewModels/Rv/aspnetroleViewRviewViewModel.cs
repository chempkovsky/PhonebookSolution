...
namespace ModelServicesPrismModule.asp.aspnetroleView.ViewModels.Rv {
    public class AspnetroleViewRviewViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetroleViewService FrmSrvaspnetroleView = null;

        public AspnetroleViewRviewViewModel(IAspnetroleViewService _FrmSrvaspnetroleView, IAppGlblSettingsService GlblSettingsSrv) {
