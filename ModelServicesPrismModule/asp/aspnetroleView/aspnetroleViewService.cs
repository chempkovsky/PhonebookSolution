...
namespace ModelServicesPrismModule.asp.aspnetroleView {
    public class AspnetroleViewService: IAspnetroleViewService
    {
        ...
        public AspnetroleViewService(IAppGlblSettingsService agstt) {
      ...
      {"Name", ("Name", "", "", false, true, true, false, "string")},  // System.String
            };
    ...
    public Dictionary<(string viewNm, string navNm, string propNm), object> getHiddenFilterByRow(IAspnetroleView rw, string nvNm) {
        ...
        foreach(string i in this._Values.Keys) {
            if(this.isInPrimkeyValue(i) || this.IsInUnkKeyValue(i)) {
                rslt[("aspnetroleView",nvNm,i)] = rw.GetType().GetProperty(i).GetValue(rw);
            }
        }
        return rslt;
    }
    ...
    protected  Dictionary<(string viewNm, string navNm, string propNm), string> _C2mfm = 
        new Dictionary<(string viewNm, string navNm, string propNm), string>() {
    {("aspnetrolemaskView", "AspNetRole", "RName"), "Name"},
    {("aspnetuserrolesView", "AspNetRole", "RoleId"), "Id"},
    };
    public Dictionary<(string viewNm, string navNm, string propNm), string> getC2mfm() {
        ...
        public async Task<IList<IAspnetroleView>> getall() {
            try
            {
                HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getall");
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return new List<IAspnetroleView>( JsonConvert.DeserializeObject<IList<AspnetroleView>>(responseBody) );
            } 
            catch(Exception e)
            {
                string exceptionMsg = "AspnetroleViewService.getall : " + e.Message;
        ...
        public async Task<IaspnetroleViewPage> getwithfilter(IAspnetroleViewFilter filter) {
            string prms = null;
            if(filter != null) {
                if (filter.Id != null) {
                ...
                if (filter.Name != null) {
                    foreach(var val in filter.Name) {
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("name") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms = "?" + Uri.EscapeDataString("name") + "=" + Uri.EscapeDataString(val.ToString());
                            else 
                                //prms += "&" + Uri.EscapeDataString("name") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms += "&" + Uri.EscapeDataString("name") + "=" + Uri.EscapeDataString(val.ToString());
                ...
                if(filter.nameOprtr != null) {
                    foreach(var val in filter.nameOprtr) {
                        if(val != null) {
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("nameOprtr") + "[]=" +  Uri.EscapeDataString(val.ToString());
                                prms = "?" + Uri.EscapeDataString("nameOprtr") + "=" +  Uri.EscapeDataString(val.ToString());
                            else 
                                //prms += "&" + Uri.EscapeDataString("nameOprtr") + "[]=" + Uri.EscapeDataString(val.ToString());
                                prms += "&" + Uri.EscapeDataString("nameOprtr") + "=" + Uri.EscapeDataString(val.ToString());
                            ...
                            if(prms == null)
                                //prms = "?" + Uri.EscapeDataString("nameOprtr") + "[]=" +  Uri.EscapeDataString("eq");
                                prms = "?" + Uri.EscapeDataString("nameOprtr") + "=" +  Uri.EscapeDataString("eq");
                            else 
                                //prms += "&" + Uri.EscapeDataString("nameOprtr") + "[]=" + Uri.EscapeDataString("eq");
                                prms += "&" + Uri.EscapeDataString("nameOprtr") + "=" + Uri.EscapeDataString("eq");
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<AspnetroleViewPage>(responseBody) ;
            } 
            catch(Exception e)
            {
                string exceptionMsg = "AspnetroleViewService.getwithfilter : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    // });
    // 
    public async Task<IAspnetroleView> getone(
        System.String Id 
        ) {
            string prms = null;
                if(prms == null)
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<AspnetroleView>(responseBody) ;
            } 
            catch(Exception e) 
            {
                string exceptionMsg = "AspnetroleViewService.getone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    public async Task<IaspnetroleViewPage> getmanybyrepprim(IAspnetroleViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.Id != null) {
                    foreach(var val in filter.Id) {
        ...
        {
            string exceptionMsg = "AspnetroleViewService.getmanybyrepprim : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    // HowTo: {prm1, prm2, ..., prmN} -- primary/unique key
    //
    // this.serviceRefInYourCode.getonebyUnqName(prm1, prm2, ..., prmN ).subscibe(value =>{
    //    // handling value of type IAspnetroleView
    // },
    // error => {
    //    // handling error 
    // });
    // 
    public async Task<IAspnetroleView> getonebyUnqName(
        System.String Name 
        ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("name") + "=" +  Uri.EscapeDataString(Name.ToString());
                else 
                    prms += "&" + Uri.EscapeDataString("name") + "=" + Uri.EscapeDataString(Name.ToString());
            if(prms == null) prms = "";
            try
            {
                HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getonebyUnqName" + prms);
                response.EnsureSuccessStatusCode();
                string responseBody = await response.Content.ReadAsStringAsync();
                return  JsonConvert.DeserializeObject<AspnetroleView>(responseBody) ;
            } 
            ...
            {
                string exceptionMsg = "AspnetroleViewService.getonebyUnqName : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
    ...
    public async Task<IaspnetroleViewPage> getmanybyrepunqUnqName(IAspnetroleViewFilter filter) {
        string prms = null;
        if(filter != null) {
                if (filter.Name != null) {
                    foreach(var val in filter.Name) {
        ...
        try
        {
            HttpResponseMessage response = await client.GetAsync(serviceUrl + "/" + "getmanybyrepunqUnqName" + prms);
            response.EnsureSuccessStatusCode();
            string responseBody = await response.Content.ReadAsStringAsync();
            return  JsonConvert.DeserializeObject<AspnetroleViewPage>(responseBody) ;
        } 
        ...
        {
            string exceptionMsg = "AspnetroleViewService.getmanybyrepunqUnqName : " + e.Message;
            Exception inner = e.InnerException;
            while (inner != null)
            {
                exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<IAspnetroleView> updateone(IAspnetroleView item) {
            if(item == null) {
            ...
            {
                string exceptionMsg = "AspnetroleViewService.updateone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<IAspnetroleView> addone(IAspnetroleView item) {
            if(item == null) {
                appGlblSettings.ShowErrorMessage("http", "Input item is not defined");
                return null;
            }
            ...
            {
                string exceptionMsg = "AspnetroleViewService.addone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public async Task<IAspnetroleView> deleteone(System.String Id ) {
            string prms = null;
                if(prms == null)
                    prms = "?" + Uri.EscapeDataString("id") + "=" +  Uri.EscapeDataString(Id.ToString());
                else 
            ...
            {
                string exceptionMsg = "AspnetroleViewService.deleteone : " + e.Message;
                Exception inner = e.InnerException;
                while (inner != null)
                {
                    exceptionMsg = exceptionMsg + ": " + inner.Message;
        ...
        public IAspnetroleViewNotify CopyToModelNotify(IAspnetroleView  src, IAspnetroleViewNotify dest = null) {
            if(dest == null) dest = new AspnetroleViewNotify();
            if(src == null) return dest;
            dest.Id = src.Id;
            dest.Name = src.Name;
            return dest;
        }
        public IAspnetroleView CopyToModel(IAspnetroleView  src, IAspnetroleView dest = null) {
            if(dest == null) dest = new AspnetroleView();
            if(src == null) return dest;
            dest.Id = src.Id;
            dest.Name = src.Name;
            return dest;
        ...
        public IAspnetroleViewFilter GetFilter() {
            return new AspnetroleViewFilter();
        }

        public IList<IWebServiceFilterRsltInterface> Row2FilterRslt(IAspnetroleView r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
        ...
        public IList<IWebServiceFilterRsltInterface> RowPrim2FilterRslt(IAspnetroleView r) {
            IList<IWebServiceFilterRsltInterface> rslt = new List<IWebServiceFilterRsltInterface>();
            if (r == null) return rslt;
            foreach(string i in this._Values.Keys) {
        ...
        public IAspnetroleViewFilter FilterRslt2Filter(IWebServiceFilterRsltInterface e, IAspnetroleViewFilter dest) {
            IAspnetroleViewFilter flt = dest;
            if(dest is null) {
                flt = GetFilter();
            }
        ...
        public IAspnetroleViewFilter FilterRslt2Filter(IList<IWebServiceFilterRsltInterface> src, IAspnetroleViewFilter dest) {
            IAspnetroleViewFilter rslt = dest;
            if(dest is null) {
                rslt = GetFilter();
            }
