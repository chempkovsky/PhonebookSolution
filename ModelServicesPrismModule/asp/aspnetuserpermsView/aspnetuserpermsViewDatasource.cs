...
namespace ModelServicesPrismModule.asp.aspnetuserpermsView {
    public class AspnetuserpermsViewDatasource: IAspnetuserpermsViewDatasource
    {
        protected readonly string _CurrentViewName   = "aspnetuserpermsView";
        ...
        protected Dictionary<string,object> _Values = new Dictionary<string,object> {
            ...
            {"UserPerms", null},  // System.Int32
        };
        protected IAspnetuserpermsViewService frmRootSrv;
        protected IAppGlblSettingsService appGlblSettings;

        public AspnetuserpermsViewDatasource(IAspnetuserpermsViewService frs,
        ...
        public Dictionary<(string viewNm, string navNm, string propNm), object>  getHiddenFilterByRow(IAspnetuserpermsView rw, string nvNm) {
        ...
        public bool Interface2Values(IAspnetuserpermsView data, bool doNotify = true) {
            if(data == null) {
            ...
            if(!this.isEqual(this.getValue("UserPerms"), data.UserPerms, "int32")) {
        ...
        public IAspnetuserpermsView Values2Interface() {
            object locobjval;

            AspnetuserpermsView rslt = new AspnetuserpermsView(); 
            ...
            locobjval = this.getValue("UserPerms");
            rslt.UserPerms = Convert.ToInt32(locobjval);
            return rslt;
        }
        ...
        protected IAspnetuserpermsViewFilter DefineFilterOneProp(IAspnetuserpermsViewFilter flt, string propNm, object value, string Oprtr) {
            if(flt == null) flt = new AspnetuserpermsViewFilter(); 
        ...
        protected IAspnetuserpermsViewFilter GetFilterByCurrDirMstrs() {
            IAspnetuserpermsViewFilter flt = new AspnetuserpermsViewFilter(); 
            Dictionary<(string viewNm, string navNm, string propNm), (bool isMstrReq, string propNm)> M2cKeyfm = this.frmRootSrv.getM2cKeyfm();
            foreach(var lkey in M2cKeyfm.Keys) {
                if (this.isSetValue(M2cKeyfm[lkey].propNm)) {
        ...
        public async Task<IList<IAspnetuserpermsView>> GetClActionByCurrDirMstrs() {
            return new List<IAspnetuserpermsView>();
        }



        public async Task<IList<IAspnetuserpermsView>> GetClActionByFldFilter(string fldName, object fldVal) {
                return new List<IAspnetuserpermsView>();
        }
