...
namespace ModelServicesPrismModule.asp.aspnetuserView.UserControls.Sform {
    public class AspnetuserViewSformViewModel: INotifyPropertyChanged, ISformViewModelInterface, IBindingContextChanged, IDestructible
    {
        protected IAspnetuserViewService FrmRootSrv=null;
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IDialogService _dialogService=null;
    

        bool CnFllscn = false;
        public AspnetuserViewSformViewModel(IAppGlblSettingsService GlblSettingsSrv, IAspnetuserViewService FrmRootSrv, 
            ...
            CnFllscn = (GlblSettingsSrv.GetViewModelMask("aspnetuserView") & 16) == 16;
        }
        ...
        #region DataSource
        protected IEnumerable<IAspnetuserView> _DataSource = new ObservableCollection<IAspnetuserView>();
        public IEnumerable<IAspnetuserView> DataSource
        { 
            get
            {
                return _DataSource;
        ...
        public async Task HiddenFiltersPropertyChanged(object Sender, object OldValue, object NewValue)
        {
            ...
            ObservableCollection<IWebServiceFilterDefInterface> fltDf = 
                new ObservableCollection<IWebServiceFilterDefInterface>() {
                    new WebServiceFilterDefViewModel() {fltrName="Id", fltrCaption="User Id",  fltrDataType="string", fltrMaxLen=128, fltrMin=null, fltrMax=null },
                    new WebServiceFilterDefViewModel() {fltrName="Email", fltrCaption="User Email",  fltrDataType="string", fltrMaxLen=256, fltrMin=null, fltrMax=null },
                    new WebServiceFilterDefViewModel() {fltrName="PhoneNumber", fltrCaption="Phone Number",  fltrDataType="string", fltrMaxLen=null, fltrMin=null, fltrMax=null },
                    new WebServiceFilterDefViewModel() {fltrName="UserName", fltrCaption="User Name",  fltrDataType="string", fltrMaxLen=256, fltrMin=null, fltrMax=null },
                };
            ActualCurrentPage = 0;
            defineSearchMethod();
            await onFilter();
        ...
        protected async Task onFilter() {
            ...
            if(SearchMethod == "NoSearchMethod") {
                ClearDataSource();
                DataSource = new ObservableCollection<IAspnetuserView>();
                SelectedRow = null;
                IsInQuery = false;
                return;
            }
            ...
            if ((SearchMethod == "FullScan")
                ...
                IAspnetuserViewFilter flt  = FrmRootSrv.GetFilter();
                ...
                IaspnetuserViewPage rslt = await this.FrmRootSrv.getwithfilter(flt);
                if(rslt != null) {
                    ...
                    SelectedRow = null;
                    ObservableCollection<IAspnetuserView> ds = DataSource as ObservableCollection<IAspnetuserView>;
                    IsDsDestroyed = true;
                    if (ds == null) { ds = new ObservableCollection<IAspnetuserView>(); } else { ds.Clear(); }
                    IsDsDestroyed = false;
                    DataSource = null; 
                    if(rslt.items != null) {
                        foreach(IAspnetuserView itm in rslt.items) {
        ...
        public void SformAfterAddItemCommand(object sender, object item) {
            IAspnetuserView prm = item as  IAspnetuserView;
            if(prm == null) return;
            ObservableCollection<IAspnetuserView> ds = DataSource as ObservableCollection<IAspnetuserView>;
        ...
        protected IList<IUniqServiceFilterDefInterface> _ScanByUkPrimaryFilterDefinitions =
            new List<IUniqServiceFilterDefInterface>() {
                new UniqServiceFilterDef() { fltrName = "Id", fltrDispMemb = "Id", fltrTextMemb = "Id", fltrCaption = "User Id", fltrDataType = "string", fltrMaxLen = 128, fltrMin = null, fltrMax = null },
            };
        ...
        protected IAspnetuserView _ScanByUkPrimaryIdItem = null;
        public IAspnetuserView ScanByUkPrimaryIdItem {
            get {
        ...
        protected IList<IAspnetuserView> _ScanByUkPrimaryItemsSource = null;
        public IList<IAspnetuserView> ScanByUkPrimaryItemsSource {
            get {
        ...
        public string ScanByUkPrimaryIdText {
            get {
                IAspnetuserView dmObj = ScanByUkPrimaryIdItem;
                if(dmObj != null) {
                    return dmObj.Id;
                } else {
        ...
        protected async void ScanByUkPrimaryTextChangedCommandExecute(object prm)
        {
            ...
            IAspnetuserView itm = null;
            IAspnetuserViewFilter fltr = FrmRootSrv.GetFilter();
            fltr.page = 0;
            fltr.pagesize = 15;
            bool runQuery = true;
            ...
            if (runQuery) {
                IaspnetuserViewPage rslt = await FrmRootSrv.getmanybyrepprim(fltr);
                if(rslt is null) {
        ...
        protected void ScanByUkPrimaryQuerySubmittedExecute(object prm)
        {
            ...
            switch(tprm.FltDef.fltrName) {
                case "Id":
                    ScanByUkPrimaryIdItem = tprm.ChosenSuggestion as IAspnetuserView;
                    break;
                default:
                    return;
            }
