...
namespace ModelServicesPrismModule.asp.aspnetuserView.UserControls.Sform {
    /// <summary>
    /// Interaction logic for AspnetuserViewSformUserControl.xaml
    /// </summary>
    public partial class AspnetuserViewSformUserControl: SformUserControlBase
    {
        public AspnetuserViewSformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
