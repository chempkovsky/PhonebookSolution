...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Aform {
    public class AspnetuserViewAformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetuserViewAformViewModel(IAspnetuserViewDatasource _rootDataSource,
