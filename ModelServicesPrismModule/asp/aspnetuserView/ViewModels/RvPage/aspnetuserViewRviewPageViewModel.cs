...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.RvPage {
    public class AspnetuserViewRviewPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;
        protected INavigationService _navigationService = null;

        public AspnetuserViewRviewPageViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "View item for User";
