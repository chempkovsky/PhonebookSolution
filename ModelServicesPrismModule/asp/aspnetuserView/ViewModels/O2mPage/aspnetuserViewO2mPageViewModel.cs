...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.O2mPage {

    public class AspnetuserViewO2mPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmRootSrvaspnetuserView = null;
        ...
        public AspnetuserViewO2mPageViewModel(IAspnetuserViewService _FrmRootSrvaspnetuserView, 
            IAspnetusermaskViewService _FrmSrvaspnetusermaskView,
            IAspnetuserrolesViewService _FrmSrvaspnetuserrolesView,
            IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
            this.GlblSettingsSrv = GlblSettingsSrv;
            this.FrmRootSrvaspnetuserView = _FrmRootSrvaspnetuserView;
       ...
       public async void OnNavigatedTo(INavigationParameters prms) {
        ...
        ObservableCollection<IO2mListItemInterface> _DetailsList = new ObservableCollection<IO2mListItemInterface>() {
            new O2mListItemViewModel() {Caption = "User Masks: AspNetUser", ForeignKeyDetails = "AspnetusermaskViewLformUserControl:AspNetUser",  Region = "AspnetusermaskViewLformUserControlDetailRegion" },
            new O2mListItemViewModel() {Caption = "User Roles: AspNetUser", ForeignKeyDetails = "AspnetuserrolesViewLformUserControl:AspNetUser",  Region = "AspnetuserrolesViewLformUserControlDetailRegion" },
        };
        ...
        protected void DefineHiddenDetailFilter() {
            ...
            IAspnetuserView  selectedMasterRow  = SelectedRow as IAspnetuserView;
            if((SelectedDetailsListItem != null) && (selectedMasterRow != null)) {
                switch(SelectedDetailsListItem.ForeignKeyDetails) {
                    case "AspnetusermaskViewLformUserControl:AspNetUser":
                        PermissionMaskDetail = GlblSettingsSrv.GetViewModelMask("aspnetusermaskView");
                        tmpFlt = this.FrmSrvaspnetusermaskView.getHiddenFilterAsFltRslt(this.FrmRootSrvaspnetuserView.getHiddenFilterByRow(selectedMasterRow, "AspNetUser"));
                        break;
                    case "AspnetuserrolesViewLformUserControl:AspNetUser":
                        PermissionMaskDetail = GlblSettingsSrv.GetViewModelMask("aspnetuserrolesView");
                        tmpFlt = this.FrmSrvaspnetuserrolesView.getHiddenFilterAsFltRslt(this.FrmRootSrvaspnetuserView.getHiddenFilterByRow(selectedMasterRow, "AspNetUser"));
                        break;
                    default:
                        break;
                }
