...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Ra {
    public class AspnetuserViewRaddViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;

        public AspnetuserViewRaddViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv) {
