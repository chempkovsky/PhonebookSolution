...
/*
    ...
    "AspnetuserViewRupdUserControl" UserControl is defined in the "ModelServicesPrismModule"-project.
    In the file of IModule-class of "ModelServicesPrismModule"-project the following line of code must be inserted:

        public void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            // According to requirements of the "AspnetuserViewRupdViewModel.cs"-file of "ModelServicesPrismModule"-project. 
            ViewModelLocationProvider.Register<AspnetuserViewRupdUserControl, AspnetuserViewRupdViewModel>();
            // According to requirements of the "AspnetuserViewRupdViewModel.cs"-file of "ModelServicesPrismModule"-project. 
            containerRegistry.RegisterForRegionNavigation<AspnetuserViewRupdUserControl, AspnetuserViewRupdViewModel>("AspnetuserViewRupdUserControl");
            // According to requirements of the "AspnetuserViewRupdViewModel.cs"-file of "ModelServicesPrismModule"-project. 
            containerRegistry.Register<ContentView, AspnetuserViewRupdUserControl>("AspnetuserViewRupdUserControl");
            ...
        }
*/

namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Ru {
    public class AspnetuserViewRupdViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;

        public AspnetuserViewRupdViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv) {
