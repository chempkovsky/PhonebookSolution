...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.RdPage {
    public class AspnetuserViewRdelPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;
        protected INavigationService _navigationService = null;

        public AspnetuserViewRdelPageViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
