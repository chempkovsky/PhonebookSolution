...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.RaPage {
    public class AspnetuserViewRaddPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;
        protected INavigationService _navigationService = null;

        public AspnetuserViewRaddPageViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                Caption = "Add item for User";
                if (resetHF) { HiddenFilters = hf; }
                FormControlModel = FrmSrvaspnetuserView.CopyToModelNotify(null,null); // this is correct: cleanup twice
                EformMode = EformModeEnum.AddMode;
                FormControlModel = null; // since DateTime-issue this is correct: FrmSrvaspnetuserView.CopyToModelNotify(null,null);
                IsParentLoaded = true;
        }
        #endregion
