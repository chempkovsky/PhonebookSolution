...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Rl {

    public class AspnetuserViewRlistViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;
        public AspnetuserViewRlistViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, 
        ...
        public void NavigateToDetailCommand(IAspnetuserView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                ...
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetusermaskViewRlistUserControlAspNetUser", Caption="User Masks: AspNetUser", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetuserrolesViewRlistUserControlAspNetUser", Caption="User Roles: AspNetUser", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        public void SformAddItemCommand() {
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetuserViewRaddUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        public void SformUpdItemCommand(IAspnetuserView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if (!CanUpdate) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetuserViewRupdUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion

        #region SformDelItemCommand
        public void SformDelItemCommand(IAspnetuserView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if(!CanDelete) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpId", selected.Id);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetuserViewRdelUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        
        #region SformViewItemCommand
        public void SformViewItemCommand(IAspnetuserView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpId", selected.Id);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetuserViewRviewUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            switch(mi.Id) {
                ...
                case "RowViewMI":
                    ...
                    break;
                    case "RowMIAspnetusermaskViewRlistUserControlAspNetUser":
                        NavigateToDetailCommand(arow, "aspnetusermaskView", "AspNetUser", "AspnetusermaskViewRlistUserControl");
                        break;
                    case "RowMIAspnetuserrolesViewRlistUserControlAspNetUser":
                        NavigateToDetailCommand(arow, "aspnetuserrolesView", "AspNetUser", "AspnetuserrolesViewRlistUserControl");
                        break;
                default:
                    break;
            }         
