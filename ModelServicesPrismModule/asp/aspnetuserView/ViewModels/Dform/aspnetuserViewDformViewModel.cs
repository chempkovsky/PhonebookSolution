...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Dform {
    public class AspnetuserViewDformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetuserViewDformViewModel(IAspnetuserViewDatasource _rootDataSource,
