...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Rld {

    public class AspnetuserViewRdlistViewModel: RegionAwareViewModelBase, IRegionAware
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;
        
        public AspnetuserViewRdlistViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspNetUser", Caption="User Masks: AspNetUser", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetuserrolesViewRdlistUserControlAspNetUser", Caption="User Roles: AspNetUser", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                    case "RowMIAspNetUser":
                        NavigateToDetailCommand(arow, "aspnetusermaskView", "AspNetUser", "");
                        break;
                    case "RowMIAspnetuserrolesViewRdlistUserControlAspNetUser":
                        NavigateToDetailCommand(arow, "aspnetuserrolesView", "AspNetUser", "AspnetuserrolesViewRdlistUserControl");
                        break;
                default:
                    break;
            }         
