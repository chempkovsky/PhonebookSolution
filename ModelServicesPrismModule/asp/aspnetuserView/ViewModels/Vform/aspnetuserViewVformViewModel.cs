...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Vform {
    public class AspnetuserViewVformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetuserViewVformViewModel(IAspnetuserViewDatasource _rootDataSource,
