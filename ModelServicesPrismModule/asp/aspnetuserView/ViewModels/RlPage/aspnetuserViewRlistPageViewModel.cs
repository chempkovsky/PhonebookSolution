...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.RlPage {

    public class AspnetuserViewRlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;
        protected INavigationService _navigationService;
        protected IRegionManager regionManager;
        public AspnetuserViewRlistPageViewModel(IRegionManager _regionManager, IAspnetuserViewService _FrmSrvaspnetuserView, 
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                ...
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetusermaskViewRlistPageAspNetUser", Caption="User Masks: AspNetUser", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetuserrolesViewRlistPageAspNetUser", Caption="User Roles: AspNetUser", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        public async Task SformAddItemCommand() {
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("AspnetuserViewRaddPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
        ...
        public async Task SformUpdItemCommand(IAspnetuserView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            INavigationResult nr2 = await _navigationService.NavigateAsync("AspnetuserViewRupdPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformDelItemCommand
        public async Task SformDelItemCommand(IAspnetuserView selected) {
            if(IsDestroyed) return;
            if (selected == null) return;
            ...
            navigationParameters.Add("pkpId", selected.Id);
            INavigationResult nr2 = await _navigationService.NavigateAsync("AspnetuserViewRdelPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion

        #region SformViewItemCommand
        public async Task SformViewItemCommand(IAspnetuserView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpId", selected.Id);
            INavigationResult nr2 = await _navigationService.NavigateAsync("AspnetuserViewRviewPage", navigationParameters);
            OnNavigationResult(nr2);
        }
        #endregion
        ...
        protected async void RowMenuItemsCommandExecute(object prm)
        {
            ...
            switch(mi.Id) {
                ...
                case "RowViewMI":
                    ...
                    break;
                    case "RowMIAspnetusermaskViewRlistPageAspNetUser":
                        await NavigateToDetailCommand(arow, "aspnetusermaskView", "AspNetUser", "AspnetusermaskViewRlistPage");
                        break;
                    case "RowMIAspnetuserrolesViewRlistPageAspNetUser":
                        await NavigateToDetailCommand(arow, "aspnetuserrolesView", "AspNetUser", "AspnetuserrolesViewRlistPage");
                        break;
                default:
                    break;
            }         
       ...
       public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if (prms.ContainsKey("EformModeEnum")) {
                ...
                if ((mode == EformModeEnum.AddMode) || (mode == EformModeEnum.UpdateMode)) {
                    ...
                    IAspnetuserView data = FrmSrvaspnetuserView.CopyToModel(null,null);
                    data.Id = pkpId;
        ...
        ObservableCollection<IO2mListItemInterface> getDetailsList() {
            ObservableCollection<IO2mListItemInterface> rslt = new ObservableCollection<IO2mListItemInterface>() {
                ...
                if((GlblSettingsSrv.GetViewModelMask("aspnetusermaskView") & 1) == 1)
                    rslt.Add(new O2mListItemViewModel() {Caption = "User Masks: AspNetUser", ForeignKeyDetails = "AspNetUser",  Region = "AspnetusermaskViewRlistUserControl" });
                if((GlblSettingsSrv.GetViewModelMask("aspnetuserrolesView") & 1) == 1)
                    rslt.Add(new O2mListItemViewModel() {Caption = "User Roles: AspNetUser", ForeignKeyDetails = "AspNetUser",  Region = "AspnetuserrolesViewRlistUserControl" });
            return rslt;
        }
        #endregion
