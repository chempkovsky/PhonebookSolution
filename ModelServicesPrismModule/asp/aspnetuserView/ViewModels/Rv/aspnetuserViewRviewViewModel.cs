...
namespace ModelServicesPrismModule.asp.aspnetuserView.ViewModels.Rv {
    public class AspnetuserViewRviewViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserViewService FrmSrvaspnetuserView = null;

        public AspnetuserViewRviewViewModel(IAspnetuserViewService _FrmSrvaspnetuserView, IAppGlblSettingsService GlblSettingsSrv) {
