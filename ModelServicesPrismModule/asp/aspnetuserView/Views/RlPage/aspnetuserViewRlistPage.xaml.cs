...
namespace ModelServicesPrismModule.asp.aspnetuserView.Views.RlPage {
    /// <summary>
    /// Interaction logic for AspnetuserViewRlistPage.xaml
    /// </summary>
    public partial class AspnetuserViewRlistPage: ContentPage, IDestructible 
    {
        public AspnetuserViewRlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetuserViewRlistPage inst = d as AspnetuserViewRlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetuserViewRlistPage),
