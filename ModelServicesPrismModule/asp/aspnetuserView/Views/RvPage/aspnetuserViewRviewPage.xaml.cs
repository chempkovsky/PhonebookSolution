...
namespace ModelServicesPrismModule.asp.aspnetuserView.Views.RvPage {
    /// <summary>
    /// Interaction logic for AspnetuserViewRviewPage.xaml
    /// </summary>
    public partial class AspnetuserViewRviewPage: ContentPage, IDestructible
    {
        public AspnetuserViewRviewPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetuserViewRviewPage inst = d as AspnetuserViewRviewPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetuserViewRviewPage),
