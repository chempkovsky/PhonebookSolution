...
namespace ModelServicesPrismModule.asp.aspnetuserView.Views.RldPage {
    /// <summary>
    /// Interaction logic for AspnetuserViewRdlistPage.xaml
    /// </summary>
    public partial class AspnetuserViewRdlistPage: ContentPage, IDestructible 
    {
        public AspnetuserViewRdlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetuserViewRdlistPage inst = d as AspnetuserViewRdlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetuserViewRdlistPage),
