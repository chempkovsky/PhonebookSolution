...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.Rld {

    public class AspnetrolemaskViewRdlistViewModel: RegionAwareViewModelBase, IRegionAware
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetrolemaskViewService FrmSrvaspnetrolemaskView = null;
        
        public AspnetrolemaskViewRdlistViewModel(IAspnetrolemaskViewService _FrmSrvaspnetrolemaskView, IAppGlblSettingsService GlblSettingsSrv) {
