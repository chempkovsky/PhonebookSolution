...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.Vform {
    public class AspnetrolemaskViewVformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetrolemaskViewVformViewModel(IAspnetrolemaskViewDatasource _rootDataSource,
