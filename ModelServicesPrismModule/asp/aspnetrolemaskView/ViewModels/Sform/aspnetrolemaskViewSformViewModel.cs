...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.Sform {
    public class AspnetrolemaskViewSformViewModel: INotifyPropertyChanged, ISformViewModelInterface, IBindingContextChanged, IDestructible
    {
        protected IAspnetrolemaskViewService FrmRootSrv=null;
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IDialogService _dialogService=null;
    

        bool CnFllscn = false;
        public AspnetrolemaskViewSformViewModel(IAppGlblSettingsService GlblSettingsSrv, IAspnetrolemaskViewService FrmRootSrv, 
            ...
            CnFllscn = (GlblSettingsSrv.GetViewModelMask("aspnetrolemaskView") & 16) == 16;
        }
        ...
        #region DataSource
        protected IEnumerable<IAspnetrolemaskView> _DataSource = new ObservableCollection<IAspnetrolemaskView>();
        public IEnumerable<IAspnetrolemaskView> DataSource
        { 
            get
            {
                return _DataSource;
        ...
        public async Task HiddenFiltersPropertyChanged(object Sender, object OldValue, object NewValue)
        {
            ...
            ObservableCollection<IWebServiceFilterDefInterface> fltDf = 
                new ObservableCollection<IWebServiceFilterDefInterface>() {
                    new WebServiceFilterDefViewModel() {fltrName="ModelPkRef", fltrCaption="Model Id",  fltrDataType="int32", fltrMaxLen=null, fltrMin=null, fltrMax=null },
                };
            bool isDsbl = true;
            ...
            if(!isDsbl) {
                fltDf.Add(new WebServiceFilterDefViewModel() {fltrName="MModelName", fltrCaption="Model Name",  fltrDataType="string", fltrMaxLen=50, fltrMin=null, fltrMax=null });
            }
            isDsbl = true;
            if (this.HiddenFiltersVM != null) {
                isDsbl = isDsbl && this.HiddenFiltersVM.Any(v => v.fltrName == "RName");
            } else isDsbl = false;
            if(!isDsbl) {
        ...
        {
                                            new WebServiceFilterDefViewModel() {fltrName="ModelPkRef", fltrCaption="Model Id",  fltrDataType="int32", fltrMaxLen=null, fltrMin=null, fltrMax=null },
                                            new WebServiceFilterDefViewModel() {fltrName="MModelName", fltrCaption="Model Name",  fltrDataType="string", fltrMaxLen=50, fltrMin=null, fltrMax=null },
        ...
        protected async Task onFilter() {
            ...
            if(SearchMethod == "NoSearchMethod") {
                ClearDataSource();
                DataSource = new ObservableCollection<IAspnetrolemaskView>();
                SelectedRow = null;
                IsInQuery = false;
                return;
            }
            ...
            if ((SearchMethod == "FullScan")
                ...
                IAspnetrolemaskViewFilter flt  = FrmRootSrv.GetFilter();
                ...
                IaspnetrolemaskViewPage rslt = await this.FrmRootSrv.getwithfilter(flt);
                if(rslt != null) {
                    ...
                    SelectedRow = null;
                    ObservableCollection<IAspnetrolemaskView> ds = DataSource as ObservableCollection<IAspnetrolemaskView>;
                    IsDsDestroyed = true;
                    if (ds == null) { ds = new ObservableCollection<IAspnetrolemaskView>(); } else { ds.Clear(); }
                    IsDsDestroyed = false;
                    DataSource = null; 
                    if(rslt.items != null) {
                        foreach(IAspnetrolemaskView itm in rslt.items) {
        ...
        public void SformAfterAddItemCommand(object sender, object item) {
            IAspnetrolemaskView prm = item as  IAspnetrolemaskView;
            if(prm == null) return;
            ObservableCollection<IAspnetrolemaskView> ds = DataSource as ObservableCollection<IAspnetrolemaskView>;
        ...
        public void SformAfterUpdItemCommand(object sender, object item) {
            ...
            IAspnetrolemaskView rw = ds.Where(d => 
                        (d.RName == prm.RName)
                    && (d.ModelPkRef == prm.ModelPkRef)
                    ).FirstOrDefault();
            if (rw != null) {
        ...
        protected IList<IUniqServiceFilterDefInterface> _ScanByUkPrimaryFilterDefinitions =
            new List<IUniqServiceFilterDefInterface>() {
                new UniqServiceFilterDef() { fltrName = "RName", fltrDispMemb = "RName", fltrTextMemb = "RName", fltrCaption = "Role Name", fltrDataType = "string", fltrMaxLen = 128, fltrMin = null, fltrMax = null },
                new UniqServiceFilterDef() { fltrName = "ModelPkRef", fltrDispMemb = "ModelPkRef", fltrTextMemb = "ModelPkRef", fltrCaption = "Model Id", fltrDataType = "int32", fltrMaxLen = null, fltrMin = null, fltrMax = null },
            };
        ...
        protected IAspnetrolemaskView _ScanByUkPrimaryRNameItem = null;
        public IAspnetrolemaskView ScanByUkPrimaryRNameItem {
            get {
                return _ScanByUkPrimaryRNameItem;
            }
            set {
                if (_ScanByUkPrimaryRNameItem != value) {
                    _ScanByUkPrimaryRNameItem = value;
                    OnPropertyChanged();
                    OnPropertyChanged("ScanByUkPrimaryRNameText");
                }
            }
        }
        protected IAspnetrolemaskView _ScanByUkPrimaryModelPkRefItem = null;
        public IAspnetrolemaskView ScanByUkPrimaryModelPkRefItem {
            get {
                return _ScanByUkPrimaryModelPkRefItem;
            }
            set {
                if (_ScanByUkPrimaryModelPkRefItem != value) {
                    _ScanByUkPrimaryModelPkRefItem = value;
                    OnPropertyChanged();
                    OnPropertyChanged("ScanByUkPrimaryModelPkRefText");
                }
            }
        }
        
        protected IList<IAspnetrolemaskView> _ScanByUkPrimaryItemsSource = null;
        public IList<IAspnetrolemaskView> ScanByUkPrimaryItemsSource {
            get {
        ...
        protected string _ScanByUkPrimaryRNameText = "";
        public string ScanByUkPrimaryRNameText {
            get {
                IAspnetrolemaskView dmObj = ScanByUkPrimaryRNameItem;
                if(dmObj != null) {
                    return dmObj.RName;
                } else {
                    return _ScanByUkPrimaryRNameText;
                }

            }
            set {
                if(_ScanByUkPrimaryRNameText != value) {
                    if(value is null)
                        _ScanByUkPrimaryRNameText = "";
                    else
                        _ScanByUkPrimaryRNameText = value;
                    OnPropertyChanged();
                }
            }
        }
        protected string _ScanByUkPrimaryModelPkRefText = "";
        public string ScanByUkPrimaryModelPkRefText {
            get {
                IAspnetrolemaskView dmObj = ScanByUkPrimaryModelPkRefItem;
                if(dmObj != null) {
                    return dmObj.ModelPkRef.ToString();
                } else {
                    return _ScanByUkPrimaryModelPkRefText;
                }

            }
            set {
                if(_ScanByUkPrimaryModelPkRefText != value) {
                    if(value is null)
                        _ScanByUkPrimaryModelPkRefText = "";
                    else
                        _ScanByUkPrimaryModelPkRefText = value;
                    OnPropertyChanged();
                }
            }
        }
        ...
        protected async void ScanByUkPrimaryTextChangedCommandExecute(object prm)
        {
            ...
            IAspnetrolemaskView itm = null;
            IAspnetrolemaskViewFilter fltr = FrmRootSrv.GetFilter();
            fltr.page = 0;
            fltr.pagesize = 15;
            bool runQuery = true;
            if (runQuery) {
                IaspnetrolemaskViewPage rslt = await FrmRootSrv.getmanybyrepprim(fltr);
                if(rslt is null) {
