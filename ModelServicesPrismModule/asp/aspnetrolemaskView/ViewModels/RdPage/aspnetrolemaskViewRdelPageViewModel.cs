...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.RdPage {
    public class AspnetrolemaskViewRdelPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetrolemaskViewRdelPageViewModel(IAspnetrolemaskViewService _FrmSrvaspnetrolemaskView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
