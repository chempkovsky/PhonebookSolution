...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.Uform {
    public class AspnetrolemaskViewUformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetrolemaskViewUformViewModel(IAspnetrolemaskViewDatasource _rootDataSource,
