...
/*
    ...
    "AspnetrolemaskViewRdelUserControl" UserControl is defined in the "ModelServicesPrismModule"-project.
    In the file of IModule-class of "ModelServicesPrismModule"-project the following line of code must be inserted:

        public void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            // According to requirements of the "AspnetrolemaskViewRdelViewModel.cs"-file of "ModelServicesPrismModule"-project. 
            ViewModelLocationProvider.Register<AspnetrolemaskViewRdelUserControl, AspnetrolemaskViewRdelViewModel>();
            // According to requirements of the "AspnetrolemaskViewRdelViewModel.cs"-file of "ModelServicesPrismModule"-project. 
            containerRegistry.RegisterForRegionNavigation<AspnetrolemaskViewRdelUserControl, AspnetrolemaskViewRdelViewModel>("AspnetrolemaskViewRdelUserControl");
            // According to requirements of the "AspnetrolemaskViewRdelViewModel.cs"-file of "ModelServicesPrismModule"-project. 
            containerRegistry.Register<ContentView, AspnetrolemaskViewRdelUserControl>("AspnetrolemaskViewRdelUserControl");
            ...
        }
*/

namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.Rd {
    public class AspnetrolemaskViewRdelViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetrolemaskViewService FrmSrvaspnetrolemaskView = null;

        public AspnetrolemaskViewRdelViewModel(IAspnetrolemaskViewService _FrmSrvaspnetrolemaskView, IAppGlblSettingsService GlblSettingsSrv) {
        ...
        public void OnNavigatedTo(INavigationContext navigationContext) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "Delete item for Role Mask";
