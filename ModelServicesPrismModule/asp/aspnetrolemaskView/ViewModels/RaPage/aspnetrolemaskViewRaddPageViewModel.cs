...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.RaPage {
    public class AspnetrolemaskViewRaddPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetrolemaskViewRaddPageViewModel(IAspnetrolemaskViewService _FrmSrvaspnetrolemaskView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
