...
namespace ModelServicesPrismModule.asp.aspnetrolemaskView.ViewModels.RuPage {
    public class AspnetrolemaskViewRupdPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetrolemaskViewRupdPageViewModel(IAspnetrolemaskViewService _FrmSrvaspnetrolemaskView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "Update item for Role Mask";
