...
namespace ModelServicesPrismModule.asp.aspnetuserrolesView.ViewModels.RvPage {
    public class AspnetuserrolesViewRviewPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetuserrolesViewRviewPageViewModel(IAspnetuserrolesViewService _FrmSrvaspnetuserrolesView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "View item for User Role";
