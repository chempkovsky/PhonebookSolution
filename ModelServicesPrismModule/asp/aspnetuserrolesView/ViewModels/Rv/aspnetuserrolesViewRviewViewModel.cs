...
namespace ModelServicesPrismModule.asp.aspnetuserrolesView.ViewModels.Rv {
    public class AspnetuserrolesViewRviewViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserrolesViewService FrmSrvaspnetuserrolesView = null;

        public AspnetuserrolesViewRviewViewModel(IAspnetuserrolesViewService _FrmSrvaspnetuserrolesView, IAppGlblSettingsService GlblSettingsSrv) {
