...
namespace ModelServicesPrismModule.asp.aspnetuserrolesView.ViewModels.RaPage {
    public class AspnetuserrolesViewRaddPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetuserrolesViewRaddPageViewModel(IAspnetuserrolesViewService _FrmSrvaspnetuserrolesView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                Caption = "Add item for User Role";
                if (resetHF) { HiddenFilters = hf; }
                FormControlModel = FrmSrvaspnetuserrolesView.CopyToModelNotify(null,null); // this is correct: cleanup twice
                EformMode = EformModeEnum.AddMode;
                FormControlModel = null; // since DateTime-issue this is correct: FrmSrvaspnetuserrolesView.CopyToModelNotify(null,null);
                IsParentLoaded = true;
        }
        #endregion
