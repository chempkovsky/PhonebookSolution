...
namespace ModelServicesPrismModule.asp.aspnetuserrolesView.ViewModels.Ru {
    public class AspnetuserrolesViewRupdViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserrolesViewService FrmSrvaspnetuserrolesView = null;

        public AspnetuserrolesViewRupdViewModel(IAspnetuserrolesViewService _FrmSrvaspnetuserrolesView, IAppGlblSettingsService GlblSettingsSrv) {
