...
namespace ModelServicesPrismModule.asp.aspnetuserrolesView.ViewModels.Aform {
    public class AspnetuserrolesViewAformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetuserrolesViewAformViewModel(IAspnetuserrolesViewDatasource _rootDataSource,
