...
namespace ModelServicesPrismModule.asp.aspnetuserrolesView.ViewModels.RldPage {

    public class AspnetuserrolesViewRdlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetuserrolesViewService FrmSrvaspnetuserrolesView = null;
        protected INavigationService _navigationService;
        public AspnetuserrolesViewRdlistPageViewModel(IAspnetuserrolesViewService _FrmSrvaspnetuserrolesView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
