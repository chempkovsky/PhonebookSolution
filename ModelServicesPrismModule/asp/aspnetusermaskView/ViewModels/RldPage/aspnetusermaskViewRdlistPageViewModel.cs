...
namespace ModelServicesPrismModule.asp.aspnetusermaskView.ViewModels.RldPage {

    public class AspnetusermaskViewRdlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
