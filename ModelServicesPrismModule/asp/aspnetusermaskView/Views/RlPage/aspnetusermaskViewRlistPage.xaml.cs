...
namespace ModelServicesPrismModule.asp.aspnetusermaskView.Views.RlPage {
    /// <summary>
    /// Interaction logic for AspnetusermaskViewRlistPage.xaml
    /// </summary>
    public partial class AspnetusermaskViewRlistPage: ContentPage, IDestructible 
    {
        public AspnetusermaskViewRlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetusermaskViewRlistPage inst = d as AspnetusermaskViewRlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetusermaskViewRlistPage),
