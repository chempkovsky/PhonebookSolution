...
namespace ModelServicesPrismModule.asp.aspnetmodelView.Views.RldPage {
    /// <summary>
    /// Interaction logic for AspnetmodelViewRdlistPage.xaml
    /// </summary>
    public partial class AspnetmodelViewRdlistPage: ContentPage, IDestructible 
    {
        public AspnetmodelViewRdlistPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetmodelViewRdlistPage inst = d as AspnetmodelViewRdlistPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetmodelViewRdlistPage),
