...
namespace ModelServicesPrismModule.asp.aspnetmodelView.Views {
    /// <summary>
    /// Interaction logic for AspnetmodelViewRviewPage.xaml
    /// </summary>
    public partial class AspnetmodelViewRviewPage: ContentPage, IDestructible
    {
        public AspnetmodelViewRviewPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetmodelViewRviewPage inst = d as AspnetmodelViewRviewPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetmodelViewRviewPage),
