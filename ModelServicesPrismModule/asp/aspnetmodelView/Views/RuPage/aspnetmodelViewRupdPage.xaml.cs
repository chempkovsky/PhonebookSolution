...
namespace ModelServicesPrismModule.asp.aspnetmodelView.Views.RuPage {
    /// <summary>
    /// Interaction logic for AspnetmodelViewRupdPage.xaml
    /// </summary>
    public partial class AspnetmodelViewRupdPage: ContentPage, IDestructible
    {
        public AspnetmodelViewRupdPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetmodelViewRupdPage inst = d as AspnetmodelViewRupdPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetmodelViewRupdPage),
