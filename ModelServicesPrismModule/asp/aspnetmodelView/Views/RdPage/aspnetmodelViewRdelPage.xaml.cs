...
namespace ModelServicesPrismModule.asp.aspnetmodelView.Views.RdPage {
    /// <summary>
    /// Interaction logic for AspnetmodelViewRdelPage.xaml
    /// </summary>
    public partial class AspnetmodelViewRdelPage: ContentPage, IDestructible
    {
        public AspnetmodelViewRdelPage()
        {
            InitializeComponent();
        }
        ...
        {
            AspnetmodelViewRdelPage inst = d as AspnetmodelViewRdelPage;
            if (inst != null)
            {
                inst.OnDestroyed();
            }
        ...
        public static readonly BindableProperty IsDestroyedProperty =
                ...
                typeof(AspnetmodelViewRdelPage),
