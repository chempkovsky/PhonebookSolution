...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels {
    ...
    public class AspnetmodelViewRlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        ...
        public AspnetmodelViewRlistPageViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
