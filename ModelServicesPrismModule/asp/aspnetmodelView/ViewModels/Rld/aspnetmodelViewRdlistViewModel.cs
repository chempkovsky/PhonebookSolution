...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Rld {

    public class AspnetmodelViewRdlistViewModel: RegionAwareViewModelBase, IRegionAware
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetmodelViewService FrmSrvaspnetmodelView = null;
        
        public AspnetmodelViewRdlistViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv) {
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetrolemaskViewRdlistUserControlAspNetModel", Caption="Role Masks: AspNetModel", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            if (arow == null) return;
            switch(mi.Id) {
                    case "RowMIAspnetrolemaskViewRdlistUserControlAspNetModel":
                        NavigateToDetailCommand(arow, "aspnetrolemaskView", "AspNetModel", "AspnetrolemaskViewRdlistUserControl");
                        break;
                default:
                    break;
            }         
