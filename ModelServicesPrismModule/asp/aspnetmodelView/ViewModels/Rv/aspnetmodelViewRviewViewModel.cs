...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Rv {
    public class AspnetmodelViewRviewViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetmodelViewService FrmSrvaspnetmodelView = null;

        public AspnetmodelViewRviewViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv) {
