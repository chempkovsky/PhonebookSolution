...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Rl {

    public class AspnetmodelViewRlistViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetmodelViewService FrmSrvaspnetmodelView = null;
        public AspnetmodelViewRlistViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, 
        ...
        public void NavigateToDetailCommand(IAspnetmodelView selected, string detailVwNm, string fkNvNm, string detailVwClNm) { 
        ...
        protected ObservableCollection<IWebServiceFilterMenuInterface> GetDefaultRowMenuItems() {
            return new ObservableCollection<IWebServiceFilterMenuInterface>()  {
                ...
                new WebServiceFilterMenuViewModel() { Id = "RowMIAspnetrolemaskViewRlistUserControlAspNetModel", Caption="Role Masks: AspNetModel", IconName="ArrowRightBold", IconColor=Color.Default, Enabled=true, Data=null, FeedbackData=null, Command = RowMenuItemsCommand},
            };
        }
        ...
        public void SformAddItemCommand() {
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetmodelViewRaddUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        public void SformUpdItemCommand(IAspnetmodelView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if (!CanUpdate) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetmodelViewRupdUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion

        #region SformDelItemCommand
        public void SformDelItemCommand(IAspnetmodelView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            if(!CanDelete) {
                CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AccessDeniedUserControl", UriKind.Relative), OnNavigationResult);
            ...
            navigationParameters.Add("pkpModelPk", selected.ModelPk);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetmodelViewRdelUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        
        #region SformViewItemCommand
        public void SformViewItemCommand(IAspnetmodelView selected) {
            if (IsDestroyed) return;
            if (selected == null) return;
            NavigationParameters navigationParameters = new NavigationParameters();
            foreach(IWebServiceFilterRsltInterface hf in HiddenFilters) {
            ...
            navigationParameters.Add("pkpModelPk", selected.ModelPk);
            CurrentNavigationContext.NavigationService.RequestNavigate(new Uri("AspnetmodelViewRviewUserControl", UriKind.Relative), OnNavigationResult, navigationParameters);
        }
        #endregion
        ...
        protected void RowMenuItemsCommandExecute(object prm)
        {
            ...
            switch(mi.Id) {
                ...
                case "RowViewMI":
                    ...
                    break;
                    case "RowMIAspnetrolemaskViewRlistUserControlAspNetModel":
                        NavigateToDetailCommand(arow, "aspnetrolemaskView", "AspNetModel", "AspnetrolemaskViewRlistUserControl");
                        break;
                default:
                    break;
            }         
