...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Ra {
    public class AspnetmodelViewRaddViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetmodelViewService FrmSrvaspnetmodelView = null;

        public AspnetmodelViewRaddViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv) {
