...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.RdPage {
    public class AspnetmodelViewRdelPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetmodelViewRdelPageViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
