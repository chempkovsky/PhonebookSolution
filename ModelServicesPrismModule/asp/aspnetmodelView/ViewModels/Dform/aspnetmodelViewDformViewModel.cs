...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Dform {
    public class AspnetmodelViewDformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetmodelViewDformViewModel(IAspnetmodelViewDatasource _rootDataSource,
