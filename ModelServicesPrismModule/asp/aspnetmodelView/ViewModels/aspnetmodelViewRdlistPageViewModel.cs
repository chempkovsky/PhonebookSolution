...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels {
    ...
    public class AspnetmodelViewRdlistPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetmodelViewRdlistPageViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
