...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.RuPage {
    public class AspnetmodelViewRupdPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetmodelViewRupdPageViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "Update item for Model";
