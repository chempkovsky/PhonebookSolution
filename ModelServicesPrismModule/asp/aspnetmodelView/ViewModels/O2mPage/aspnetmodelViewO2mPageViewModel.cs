...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.O2mPage {

    public class AspnetmodelViewO2mPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetmodelViewService FrmRootSrvaspnetmodelView = null;
        protected INavigationService _navigationService;
        protected IAspnetrolemaskViewService FrmSrvaspnetrolemaskView = null;
        public AspnetmodelViewO2mPageViewModel(IAspnetmodelViewService _FrmRootSrvaspnetmodelView, 
            IAspnetrolemaskViewService _FrmSrvaspnetrolemaskView,
            IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
            this.GlblSettingsSrv = GlblSettingsSrv;
            this.FrmRootSrvaspnetmodelView = _FrmRootSrvaspnetmodelView;
       ...
       public async void OnNavigatedTo(INavigationParameters prms) {
        ...
        ObservableCollection<IO2mListItemInterface> _DetailsList = new ObservableCollection<IO2mListItemInterface>() {
            new O2mListItemViewModel() {Caption = "Role Masks: AspNetModel", ForeignKeyDetails = "AspnetrolemaskViewLformUserControl:AspNetModel",  Region = "AspnetrolemaskViewLformUserControlDetailRegion" },
        };
        ...
        protected void DefineHiddenDetailFilter() {
            ...
            IAspnetmodelView  selectedMasterRow  = SelectedRow as IAspnetmodelView;
            if((SelectedDetailsListItem != null) && (selectedMasterRow != null)) {
                switch(SelectedDetailsListItem.ForeignKeyDetails) {
                    case "AspnetrolemaskViewLformUserControl:AspNetModel":
                        PermissionMaskDetail = GlblSettingsSrv.GetViewModelMask("aspnetrolemaskView");
                        tmpFlt = this.FrmSrvaspnetrolemaskView.getHiddenFilterAsFltRslt(this.FrmRootSrvaspnetmodelView.getHiddenFilterByRow(selectedMasterRow, "AspNetModel"));
                        break;
                    default:
                        break;
                }
