...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.RvPage {
    public class AspnetmodelViewRviewPageViewModel: INotifyPropertyChanged, INavigationAware, IDestructible  
    {
        ...
        public AspnetmodelViewRviewPageViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv, INavigationService navigationService) {
        ...
        public void OnNavigatedTo(INavigationParameters prms) {
            ...
            if ((!resetHF) && (hf.Count > 0)) {
                ...
                string locCaption = "View item for Model";
