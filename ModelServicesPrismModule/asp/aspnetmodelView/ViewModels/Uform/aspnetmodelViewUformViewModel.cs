...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Uform {
    public class AspnetmodelViewUformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetmodelViewUformViewModel(IAspnetmodelViewDatasource _rootDataSource,
