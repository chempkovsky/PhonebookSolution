...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Vform {
    public class AspnetmodelViewVformViewModel: INotifyPropertyChanged, INotifyDataErrorInfo, IEformViewModelInterface, IBindingContextChanged
    {
        ...
        #region Constructor
        public AspnetmodelViewVformViewModel(IAspnetmodelViewDatasource _rootDataSource,
