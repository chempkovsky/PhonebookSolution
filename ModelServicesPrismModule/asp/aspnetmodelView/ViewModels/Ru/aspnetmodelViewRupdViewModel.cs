...
namespace ModelServicesPrismModule.asp.aspnetmodelView.ViewModels.Ru {
    public class AspnetmodelViewRupdViewModel: RegionAwareViewModelBase, IRegionAware 
    {
        protected IAppGlblSettingsService GlblSettingsSrv=null;
        protected IAspnetmodelViewService FrmSrvaspnetmodelView = null;

        public AspnetmodelViewRupdViewModel(IAspnetmodelViewService _FrmSrvaspnetmodelView, IAppGlblSettingsService GlblSettingsSrv) {
