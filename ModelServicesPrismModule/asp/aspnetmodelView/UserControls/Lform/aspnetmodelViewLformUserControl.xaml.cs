...
namespace ModelServicesPrismModule.asp.aspnetmodelView.UserControls.Lform {
    /// <summary>
    /// Interaction logic for AspnetmodelViewLformUserControl.xaml
    /// </summary>
    public partial class AspnetmodelViewLformUserControl: LformUserControlBase
    {
        public AspnetmodelViewLformUserControl()
        {
            InitializeComponent();
            OnLoaded();
        }
