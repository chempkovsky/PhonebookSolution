...
using PrismPhonebook.Droid.Controls;

[assembly: ExportRenderer(typeof(NullableDatePicker), typeof(NullableDatePickerDroidRenderer))]
namespace PrismPhonebook.Droid.Controls {
    public class NullableDatePickerDroidRenderer: ViewRenderer<NullableDatePicker, Android.Widget.EditText>
    {
        public NullableDatePickerDroidRenderer(Context context) : base(context)
        {
        }
