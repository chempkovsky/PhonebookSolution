...
//    [RoutePrefix("lprphone03viewwebapi")]
    [ApiController]
    public class LprPhone03ViewWebApiController: ControllerBase
    {
        ...
        public LprPhone03ViewWebApiController(LpPhnPhBkContext context)
        {
            db = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<LprPhone03View>>> getall()
        {
            return await db.LprPhone03DbSet
                    .Select(itm => new LprPhone03View() {
                            PhoneId = itm.PhoneId,
        ...
        public async Task<ActionResult<LprPhone03ViewPage>> getwithfilter(                
            ...
            [FromQuery] int? pagesize = null)
        {
            ...
            IQueryable<LprPhone03> query = db.LprPhone03DbSet;
            ...
            if (_phoneTypeIdRef > 0) {
                ...
                IOrderedQueryable<LprPhone03> orderedQuery = null;
                ...
                LprPhone03ViewPage resultObject = new LprPhone03ViewPage() {
                    page = (currentPage > 0) ? (currentPage-1) : currentPage,
                    pagesize = currentPageSize,
                    pagecount = pageCount,
                    total = totals
                };
                resultObject.items = await orderedQuery.Skip((currentPage - 1) * currentPageSize).Take(currentPageSize).Select(itm => new LprPhone03View() {
                            PhoneId = itm.PhoneId,
                            LpdPhoneIdRef = itm.LpdPhoneIdRef,
                            PhoneTypeIdRef = itm.PhoneTypeIdRef
                            }).ToListAsync();
        ...
        public async Task<ActionResult<LprPhone03View>> getone(                
             [FromQuery] System.Int32 phoneTypeIdRef
        ...
        {
            LprPhone03View result = await db.LprPhone03DbSet
        ...
        public async Task<ActionResult<LprPhone03ViewPage>> getmanybyrepprim(
            ...
            [FromQuery] int? pagesize = null)
        {
            ...
            IQueryable<LprPhone03> query = db.LprPhone03DbSet;
            var _outer = PredicateBuilder.New<LprPhone03>(false);
            bool isOuterModified = false;
            if ( _phoneTypeIdRef > 0 ) {
                bool isLkOp = false;
                for(int i = 0; i < _phoneTypeIdRef; i++) {
                    var _inner = PredicateBuilder.New<LprPhone03>(true);
                    isLkOp = false;
            ...
            var _outerAnd = PredicateBuilder.New<LprPhone03>(true);
            ...
            resultObject.items = await query.Skip((currentPage - 1) * currentPageSize).Take(currentPageSize).Select(itm => new LprPhone03View() {
                            PhoneId = itm.PhoneId,
                            LpdPhoneIdRef = itm.LpdPhoneIdRef,
                            PhoneTypeIdRef = itm.PhoneTypeIdRef
                            }).ToListAsync();
        ...
        public async Task<ActionResult<LprPhone03View>> updateone([FromBody] LprPhone03View viewToUpdate)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            }
            LprPhone03 resultEntity = await db.LprPhone03DbSet
        ...
        public async Task<ActionResult<LprPhone03View>> addone([FromBody] LprPhone03View viewToAdd)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            }
            LprPhone03 entityToAdd = new LprPhone03();
            ...
            db.LprPhone03DbSet.Add(entityToAdd);
            await db.SaveChangesAsync();
        ...
        public async Task<ActionResult<LprPhone03View>> deleteone(                
             [FromQuery] System.Int32 phoneTypeIdRef
           ...
           )
        {
                ...
                LprPhone03 entityToDelete = await db.LprPhone03DbSet
                ...
                db.LprPhone03DbSet.Remove(entityToDelete);
                await db.SaveChangesAsync();
                return Ok(result);
        }
