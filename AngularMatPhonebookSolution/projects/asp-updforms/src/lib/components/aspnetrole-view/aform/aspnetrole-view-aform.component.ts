...
@Component({
  selector: 'app-aspnetrole-view-aform',
  templateUrl: './aspnetrole-view-aform.component.html',
  styleUrls: ['./aspnetrole-view-aform.component.css']
})
export class AspnetroleViewAformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetroleViewAformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Add Role@@AspnetroleViewAformComponent.Review-Item:Add Role`,
        'title': $localize`:Select Item@@AspnetroleViewAformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetroleViewAformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the AspnetroleViewAformComponent class body
