...
@Component({
  selector: 'app-aspnetrole-view-dform',
  templateUrl: './aspnetrole-view-dform.component.html',
  styleUrls: ['./aspnetrole-view-dform.component.css']
})
export class AspnetroleViewDformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetroleViewDformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Delete Role@@AspnetroleViewDformComponent.Delete-Item:Delete Role`,
        'title': $localize`:Select Item@@AspnetroleViewDformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetroleViewDformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the AspnetroleViewDformComponent class body
