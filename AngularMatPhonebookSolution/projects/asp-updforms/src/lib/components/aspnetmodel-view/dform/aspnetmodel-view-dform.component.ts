...
@Component({
  selector: 'app-aspnetmodel-view-dform',
  templateUrl: './aspnetmodel-view-dform.component.html',
  styleUrls: ['./aspnetmodel-view-dform.component.css']
})
export class AspnetmodelViewDformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetmodelViewDformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Delete Model@@AspnetmodelViewDformComponent.Delete-Item:Delete Model`,
        'title': $localize`:Select Item@@AspnetmodelViewDformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetmodelViewDformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the AspnetmodelViewDformComponent class body
