...
@Component({
  selector: 'app-aspnetmodel-view-aform',
  templateUrl: './aspnetmodel-view-aform.component.html',
  styleUrls: ['./aspnetmodel-view-aform.component.css']
})
export class AspnetmodelViewAformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetmodelViewAformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Add Model@@AspnetmodelViewAformComponent.Review-Item:Add Model`,
        'title': $localize`:Select Item@@AspnetmodelViewAformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetmodelViewAformComponent.Not-all-masters:Not all masters have been set`,
    ...
    constructor(private frmSrvaspnetmodelView: AspnetmodelViewService, public dialog: MatDialog, protected appGlblSettings: AppGlblSettingsService ) {
        ...
        this.mainFormGroup.addControl('modelPk', frmcntrl);
        frmcntrl.valueChanges.subscribe({next: (val: any) => { 
            this.rootDataSource.setValue('modelPk', val);
        }});
...
} // the end of the AspnetmodelViewAformComponent class body
