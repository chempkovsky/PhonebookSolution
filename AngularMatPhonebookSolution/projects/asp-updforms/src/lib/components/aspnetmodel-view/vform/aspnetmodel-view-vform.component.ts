...
@Component({
  selector: 'app-aspnetmodel-view-vform',
  templateUrl: './aspnetmodel-view-vform.component.html',
  styleUrls: ['./aspnetmodel-view-vform.component.css']
})
export class AspnetmodelViewVformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetmodelViewVformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Review Model@@AspnetmodelViewVformComponent.Review-Item:Review Model`,
        'title': $localize`:Select Item@@AspnetmodelViewVformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetmodelViewVformComponent.Not-all-masters:Not all masters have been set`,
    ...
    public doSubmit(): void {
        ...
        let data: IaspnetmodelView = this.rootDataSource.values2Interface();
    ...
    constructor(private frmSrvaspnetmodelView: AspnetmodelViewService, public dialog: MatDialog, protected appGlblSettings: AppGlblSettingsService ) {
        ...
        this.mainFormGroup.addControl('modelName', new FormControl({ value: null, disabled: false}, locValidators));
        locValidators = [ Validators.maxLength(50),Validators.minLength(1) ];
        this.mainFormGroup.addControl('modelDescription', new FormControl({ value: null, disabled: false}, locValidators));
...
} // the end of the AspnetmodelViewVformComponent class body
