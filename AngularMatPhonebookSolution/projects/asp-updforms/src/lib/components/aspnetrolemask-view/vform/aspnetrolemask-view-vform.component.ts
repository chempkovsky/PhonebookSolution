...
@Component({
  selector: 'app-aspnetrolemask-view-vform',
  templateUrl: './aspnetrolemask-view-vform.component.html',
  styleUrls: ['./aspnetrolemask-view-vform.component.css']
})
export class AspnetrolemaskViewVformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetrolemaskViewVformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Review Role Mask@@AspnetrolemaskViewVformComponent.Review-Item:Review Role Mask`,
        'title': $localize`:Select Item@@AspnetrolemaskViewVformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetrolemaskViewVformComponent.Not-all-masters:Not all masters have been set`,
    ...
    public doSubmit(): void {
        ...
        let data: IaspnetrolemaskView = this.rootDataSource.values2Interface();
...
} // the end of the AspnetrolemaskViewVformComponent class body
