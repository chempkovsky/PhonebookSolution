...
@Component({
  selector: 'app-aspnetrolemask-view-uform',
  templateUrl: './aspnetrolemask-view-uform.component.html',
  styleUrls: ['./aspnetrolemask-view-uform.component.css']
})
export class AspnetrolemaskViewUformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetrolemaskViewUformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Update Role Mask@@AspnetrolemaskViewUformComponent.Update-Item:Update Role Mask`,
        'title': $localize`:Select Item@@AspnetrolemaskViewUformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetrolemaskViewUformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the AspnetrolemaskViewUformComponent class body
