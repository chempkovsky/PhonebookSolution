...
@Component({
  selector: 'app-aspnetuser-view-aform',
  templateUrl: './aspnetuser-view-aform.component.html',
  styleUrls: ['./aspnetuser-view-aform.component.css']
})
export class AspnetuserViewAformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetuserViewAformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Add User@@AspnetuserViewAformComponent.Review-Item:Add User`,
        'title': $localize`:Select Item@@AspnetuserViewAformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetuserViewAformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the AspnetuserViewAformComponent class body
