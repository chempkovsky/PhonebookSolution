...
@Component({
  selector: 'app-aspnetuserroles-view-aform',
  templateUrl: './aspnetuserroles-view-aform.component.html',
  styleUrls: ['./aspnetuserroles-view-aform.component.css']
})
export class AspnetuserrolesViewAformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@AspnetuserrolesViewAformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Add User Role@@AspnetuserrolesViewAformComponent.Review-Item:Add User Role`,
        'title': $localize`:Select Item@@AspnetuserrolesViewAformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@AspnetuserrolesViewAformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the AspnetuserrolesViewAformComponent class body
