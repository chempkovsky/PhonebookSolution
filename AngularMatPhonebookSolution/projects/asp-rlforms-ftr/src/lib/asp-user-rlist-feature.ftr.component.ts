...
@Component({
  selector: 'app-asp-user-rlist-feature-ftr',
  templateUrl: './asp-user-rlist-feature.ftr.component.html',
  styleUrls: ['./asp-user-rlist-feature.ftr.component.css']
})
export class AspUserRlistFeatureFtrComponent  {
