...
@Component({
  selector: 'app-rd-lists-feature-ftr',
  templateUrl: './rd-lists-feature.ftr.component.html',
  styleUrls: ['./rd-lists-feature.ftr.component.css']
})
export class RdListsFeatureFtrComponent  {
