...
@Component({
  selector: 'app-lforms-feature-ftr',
  templateUrl: './lforms-feature.ftr.component.html',
  styleUrls: ['./lforms-feature.ftr.component.css']
})
export class LformsFeatureFtrComponent  {
    ...
    ngOnInit(): void {
        let msk: number = 0;
        msk = this.appGlblSettings.getViewModelMask('PhbkPhoneTypeView');
