...
export class LprEmployee01ViewService {
    serviceUrl: string;  
    ...
    public getHiddenFilterByRow(rw: ILprEmployee01View|any, nvNm: string|any): {[key: string]: {[key: string]: {[key: string]: any}}} {
        ...
        for(let i in this._Values) {
            if(this.isInPrimkeyValue(i) || this.IsInUnkKeyValue(i)) {
                if(typeof rslt['LprEmployee01View'] === 'undefined') rslt['LprEmployee01View'] = {};
                if(typeof rslt['LprEmployee01View'][nvNm] === 'undefined') rslt['LprEmployee01View'][nvNm] = {};
                rslt['LprEmployee01View'][nvNm][i] = rw[i];
            }
        }
        return rslt;
    }
...
*/
    ...
    // });
    // 
    getall(): Observable<ILprEmployee01View[]> {

        return this.http.get<ILprEmployee01View[]>(this.serviceUrl+'/getall');
        //    .pipe(
    ...
    // 
    // HowTo: flt is of type ILprEmployee01ViewFilter 
    //
    // this.serviceRefInYourCode.getwithfilter(flt).subscibe(value =>{
    //    // handling value of type ILprEmployee01ViewPage
    // },
    // error => {
    //    // handling error 
    // });
    // 
    getwithfilter(filter: ILprEmployee01ViewFilter): Observable<ILprEmployee01ViewPage> {
        ...
        return this.http.get<ILprEmployee01ViewPage>(this.serviceUrl+'/getwithfilter', options);
          //    .pipe(
    ...
    getone(
        ...
        const options = hasFilter ? { params } : {};
        return this.http.get<ILprEmployee01View>(this.serviceUrl+'/getone', options);
          // .pipe(
          //   catchError(this.handleError('getone', []))
          // );
    }

    getmanybyrepprim(filter: ILprEmployee01ViewFilter): Observable<ILprEmployee01ViewPage> {
        let params: HttpParams  = new HttpParams({encoder: this.appGlblSettings});
        let hasFilter: boolean = false;
        if (!(typeof filter === 'undefined')) {
            if (!(filter === null )) {
        ...
        const options = hasFilter ? { params } : {};
        return this.http.get<ILprEmployee01ViewPage>(this.serviceUrl+'/getmanybyrepprim', options);
    }


    // 
    // HowTo: item is of type ILprEmployee01View 
    //
    ...
    // });
    // 
    updateone(item: ILprEmployee01View): Observable<ILprEmployee01View> {

        return this.http.put<ILprEmployee01View>(this.serviceUrl+'/updateone', item); //, httpOptions);
        //  .pipe(
    ...
    // });
    // 
    addone(item: ILprEmployee01View): Observable<ILprEmployee01View> {
        return this.http.post<ILprEmployee01View>(this.serviceUrl+'/addone', item); //, httpOptions);
        // .pipe(
    ...
    // });
    // 
    deleteone(empLastNameIdRef: number|any , empFirstNameIdRef: number|any , empSecondNameIdRef: number|any , employeeId: number|any ): Observable<ILprEmployee01View> {
        let params: HttpParams  = new HttpParams({encoder: this.appGlblSettings});
        let hasFilter: boolean = false;
        if (!(typeof employeeId === 'undefined')) {
            if (!(employeeId === null)) {
        ...
        const options = hasFilter ? { params } : {};
        return this.http.delete<ILprEmployee01View>(this.serviceUrl+'/deleteone', options); //, httpOptions);
        // .pipe(
        //      catchError(this.handleError('deleteone', item))
        // );   
    }

    src2dest(src: ILprEmployee01View, dest: ILprEmployee01View) {
    ...
    row2FilterRslt(r: ILprEmployee01View| any): Array<IWebServiceFilterRslt> {
        let rslt: Array<IWebServiceFilterRslt> = [];
