...
import { AspnetuserrolesViewAformComponent } from 'asp-updforms';


@Component({
  selector: 'app-aspnetuserroles-view-r-a',
  templateUrl: './aspnetuserroles-view-r-a.component.html',
  styleUrls: ['./aspnetuserroles-view-r-a.component.css']
})

export class AspnetuserrolesViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add User Role@@AspnetuserrolesViewRAComponent.AddaspnetuserrolesView:Add User Role`,
    };
