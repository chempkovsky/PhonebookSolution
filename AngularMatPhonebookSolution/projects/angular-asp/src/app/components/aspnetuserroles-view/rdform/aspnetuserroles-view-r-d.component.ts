...
import { AspnetuserrolesViewDformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetuserroles-view-r-d',
  templateUrl: './aspnetuserroles-view-r-d.component.html',
  styleUrls: ['./aspnetuserroles-view-r-d.component.css']
})

export class AspnetuserrolesViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete User Role@@AspnetuserrolesViewRDComponent.DeleteaspnetuserrolesView:Delete User Role`,
    };
