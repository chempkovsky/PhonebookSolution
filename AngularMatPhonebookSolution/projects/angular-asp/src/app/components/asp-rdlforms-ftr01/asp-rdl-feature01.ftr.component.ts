...
@Component({
  selector: 'app-asp-rdl-feature01-ftr',
  templateUrl: './asp-rdl-feature01.ftr.component.html',
  styleUrls: ['./asp-rdl-feature01.ftr.component.css']
})
export class AspRdlFeature01FtrComponent  {
