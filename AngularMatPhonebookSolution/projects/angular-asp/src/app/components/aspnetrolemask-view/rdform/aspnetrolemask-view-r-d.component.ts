...
import { AspnetrolemaskViewDformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetrolemask-view-r-d',
  templateUrl: './aspnetrolemask-view-r-d.component.html',
  styleUrls: ['./aspnetrolemask-view-r-d.component.css']
})

export class AspnetrolemaskViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete Role Mask@@AspnetrolemaskViewRDComponent.DeleteaspnetrolemaskView:Delete Role Mask`,
    };
...
*/
    ...
    onAfterSubmit(newVal: IaspnetrolemaskView) {
        ...
        flt['rName'] = newVal.rName;
      
        flt['modelPkRef'] = newVal.modelPkRef;
