...
import { AspnetrolemaskViewAformComponent } from 'asp-updforms';


@Component({
  selector: 'app-aspnetrolemask-view-r-a',
  templateUrl: './aspnetrolemask-view-r-a.component.html',
  styleUrls: ['./aspnetrolemask-view-r-a.component.css']
})

export class AspnetrolemaskViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add Role Mask@@AspnetrolemaskViewRAComponent.AddaspnetrolemaskView:Add Role Mask`,
    };
