...
import { AspnetrolemaskViewUformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetrolemask-view-r-u',
  templateUrl: './aspnetrolemask-view-r-u.component.html',
  styleUrls: ['./aspnetrolemask-view-r-u.component.css']
})

export class AspnetrolemaskViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update Role Mask@@AspnetrolemaskViewRUComponent.UpdateaspnetrolemaskView:Update Role Mask`,
    };
