...
export class AspnetmodelViewRdlistComponent implements OnInit, OnDestroy, IEventEmitterPub, IItemHeightData {
    frases: {[key:string]: string}  = {
        ...
        'permission': $localize`:Permission@@AspnetmodelViewRdlistComponent.permission:Permission`,
        'accessdenied': $localize`:Access denied@@AspnetmodelViewRdlistComponent.accessdenied:Access denied`,
