...
import { AspnetmodelViewUformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetmodel-view-r-u',
  templateUrl: './aspnetmodel-view-r-u.component.html',
  styleUrls: ['./aspnetmodel-view-r-u.component.css']
})

export class AspnetmodelViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update Model@@AspnetmodelViewRUComponent.UpdateaspnetmodelView:Update Model`,
    };
