...
import { AspnetmodelViewDformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetmodel-view-r-d',
  templateUrl: './aspnetmodel-view-r-d.component.html',
  styleUrls: ['./aspnetmodel-view-r-d.component.css']
})

export class AspnetmodelViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete Model@@AspnetmodelViewRDComponent.DeleteaspnetmodelView:Delete Model`,
    };
