...
import { AspnetroleViewUformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetrole-view-r-u',
  templateUrl: './aspnetrole-view-r-u.component.html',
  styleUrls: ['./aspnetrole-view-r-u.component.css']
})

export class AspnetroleViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update Role@@AspnetroleViewRUComponent.UpdateaspnetroleView:Update Role`,
    };
