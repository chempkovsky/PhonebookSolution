...
import { AspnetroleViewDformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetrole-view-r-d',
  templateUrl: './aspnetrole-view-r-d.component.html',
  styleUrls: ['./aspnetrole-view-r-d.component.css']
})

export class AspnetroleViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete Role@@AspnetroleViewRDComponent.DeleteaspnetroleView:Delete Role`,
    };
