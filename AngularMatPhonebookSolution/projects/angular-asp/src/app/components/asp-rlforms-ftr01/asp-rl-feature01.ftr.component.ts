...
@Component({
  selector: 'app-asp-rl-feature01-ftr',
  templateUrl: './asp-rl-feature01.ftr.component.html',
  styleUrls: ['./asp-rl-feature01.ftr.component.css']
})
export class AspRlFeature01FtrComponent  {
