...
import { AspnetuserViewDformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetuser-view-r-d',
  templateUrl: './aspnetuser-view-r-d.component.html',
  styleUrls: ['./aspnetuser-view-r-d.component.css']
})

export class AspnetuserViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete User@@AspnetuserViewRDComponent.DeleteaspnetuserView:Delete User`,
    };
