...
import { AspnetuserViewUformComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetuser-view-r-u',
  templateUrl: './aspnetuser-view-r-u.component.html',
  styleUrls: ['./aspnetuser-view-r-u.component.css']
})

export class AspnetuserViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update User@@AspnetuserViewRUComponent.UpdateaspnetuserView:Update User`,
    };
