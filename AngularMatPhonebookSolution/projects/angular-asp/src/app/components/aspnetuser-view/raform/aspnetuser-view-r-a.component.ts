...
import { AspnetuserViewAformComponent } from 'asp-updforms';


@Component({
  selector: 'app-aspnetuser-view-r-a',
  templateUrl: './aspnetuser-view-r-a.component.html',
  styleUrls: ['./aspnetuser-view-r-a.component.css']
})

export class AspnetuserViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add User@@AspnetuserViewRAComponent.AddaspnetuserView:Add User`,
    };
