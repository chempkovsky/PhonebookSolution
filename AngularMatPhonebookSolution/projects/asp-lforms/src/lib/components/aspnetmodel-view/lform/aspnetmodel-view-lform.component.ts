...
import { IaspnetmodelViewVdlg } from 'asp-updforms';
import { AspnetmodelViewVdlgComponent } from 'asp-updforms';
import { IaspnetmodelViewAdlg } from 'asp-updforms';
import { AspnetmodelViewAdlgComponent } from 'asp-updforms';
import { IaspnetmodelViewUdlg } from 'asp-updforms';
import { AspnetmodelViewUdlgComponent } from 'asp-updforms';
import { IaspnetmodelViewDdlg } from 'asp-updforms';
import { AspnetmodelViewDdlgComponent } from 'asp-updforms';

@Component({
  selector: 'app-aspnetmodel-view-lform',
  templateUrl: './aspnetmodel-view-lform.component.html',
  styleUrls: ['./aspnetmodel-view-lform.component.css']
})
export class AspnetmodelViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    frases: {[key:string]: string}  = {
        'caption': $localize`:Models@@AspnetmodelViewLformComponent.caption:Models`,
        'update': $localize`:Modify Item@@AspnetmodelViewLformComponent.update:Modify Item`,
        'delete': $localize`:Delete Item@@AspnetmodelViewLformComponent.delete:Delete Item`,
        'view': $localize`:View Item@@AspnetmodelViewLformComponent.view:View Item`,
        'add': $localize`:Add Item@@AspnetmodelViewLformComponent.add:Add Item`,
        'deletesel': $localize`:Delete Selected@@AspnetmodelViewLformComponent.deletesel:Delete Selected`,
        'permission': $localize`:Permission@@AspnetmodelViewLformComponent.permission:Permission`,
        'accessdenied': $localize`:Access denied@@AspnetmodelViewLformComponent.accessdenied:Access denied`,
    }
    ...
    constructor(private  frmRootSrv: AspnetmodelViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
