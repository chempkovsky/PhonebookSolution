...
@Component({
  selector: 'app-aspnetrole-view-lform',
  templateUrl: './aspnetrole-view-lform.component.html',
  styleUrls: ['./aspnetrole-view-lform.component.css']
})
export class AspnetroleViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    frases: {[key:string]: string}  = {
        'caption': $localize`:Roles@@AspnetroleViewLformComponent.caption:Roles`,
        'update': $localize`:Modify Item@@AspnetroleViewLformComponent.update:Modify Item`,
        'delete': $localize`:Delete Item@@AspnetroleViewLformComponent.delete:Delete Item`,
        'view': $localize`:View Item@@AspnetroleViewLformComponent.view:View Item`,
        'add': $localize`:Add Item@@AspnetroleViewLformComponent.add:Add Item`,
        'deletesel': $localize`:Delete Selected@@AspnetroleViewLformComponent.deletesel:Delete Selected`,
        'permission': $localize`:Permission@@AspnetroleViewLformComponent.permission:Permission`,
        'accessdenied': $localize`:Access denied@@AspnetroleViewLformComponent.accessdenied:Access denied`,
    }
    ...
    constructor(private  frmRootSrv: AspnetroleViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
