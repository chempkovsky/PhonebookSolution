...
import { PhbkPhoneTypeViewAformComponent } from 'phonebook-updforms';


@Component({
  selector: 'app-phbk-phone-type-view-r-a',
  templateUrl: './phbk-phone-type-view-r-a.component.html',
  styleUrls: ['./phbk-phone-type-view-r-a.component.css']
})

export class PhbkPhoneTypeViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add Phone Type@@PhbkPhoneTypeViewRAComponent.AddPhbkPhoneTypeView:Add Phone Type`,
    };
