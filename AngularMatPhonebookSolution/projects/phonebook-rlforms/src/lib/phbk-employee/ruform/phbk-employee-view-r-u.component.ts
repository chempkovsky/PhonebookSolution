...
import { PhbkEmployeeViewUformComponent } from 'phonebook-updforms';

@Component({
  selector: 'app-phbk-employee-view-r-u',
  templateUrl: './phbk-employee-view-r-u.component.html',
  styleUrls: ['./phbk-employee-view-r-u.component.css']
})

export class PhbkEmployeeViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update Employee@@PhbkEmployeeViewRUComponent.UpdatePhbkEmployeeView:Update Employee`,
    };
