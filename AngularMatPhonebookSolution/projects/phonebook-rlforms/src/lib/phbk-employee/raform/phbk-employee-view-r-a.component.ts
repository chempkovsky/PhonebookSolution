...
import { PhbkEmployeeViewAformComponent } from 'phonebook-updforms';


@Component({
  selector: 'app-phbk-employee-view-r-a',
  templateUrl: './phbk-employee-view-r-a.component.html',
  styleUrls: ['./phbk-employee-view-r-a.component.css']
})

export class PhbkEmployeeViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add Employee@@PhbkEmployeeViewRAComponent.AddPhbkEmployeeView:Add Employee`,
    };
