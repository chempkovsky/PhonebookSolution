...
import { PhbkEnterpriseViewUformComponent } from 'phonebook-updforms';

@Component({
  selector: 'app-phbk-enterprise-view-r-u',
  templateUrl: './phbk-enterprise-view-r-u.component.html',
  styleUrls: ['./phbk-enterprise-view-r-u.component.css']
})

export class PhbkEnterpriseViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update Enterprise@@PhbkEnterpriseViewRUComponent.UpdatePhbkEnterpriseView:Update Enterprise`,
    };
