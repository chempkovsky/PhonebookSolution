...
import { PhbkEnterpriseViewAformComponent } from 'phonebook-updforms';


@Component({
  selector: 'app-phbk-enterprise-view-r-a',
  templateUrl: './phbk-enterprise-view-r-a.component.html',
  styleUrls: ['./phbk-enterprise-view-r-a.component.css']
})

export class PhbkEnterpriseViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add Enterprise@@PhbkEnterpriseViewRAComponent.AddPhbkEnterpriseView:Add Enterprise`,
    };
