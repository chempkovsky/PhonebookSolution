...
import { PhbkEnterpriseViewDformComponent } from 'phonebook-updforms';

@Component({
  selector: 'app-phbk-enterprise-view-r-d',
  templateUrl: './phbk-enterprise-view-r-d.component.html',
  styleUrls: ['./phbk-enterprise-view-r-d.component.css']
})

export class PhbkEnterpriseViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete Enterprise@@PhbkEnterpriseViewRDComponent.DeletePhbkEnterpriseView:Delete Enterprise`,
    };
...
*/
    ...
    onAfterSubmit(newVal: IPhbkEnterpriseView) {
        ...
        flt['entrprsId'] = newVal.entrprsId;
