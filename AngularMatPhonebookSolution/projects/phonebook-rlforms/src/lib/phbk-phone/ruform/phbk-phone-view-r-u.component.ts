...
import { PhbkPhoneViewUformComponent } from 'phonebook-updforms';

@Component({
  selector: 'app-phbk-phone-view-r-u',
  templateUrl: './phbk-phone-view-r-u.component.html',
  styleUrls: ['./phbk-phone-view-r-u.component.css']
})

export class PhbkPhoneViewRUComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Update Phone@@PhbkPhoneViewRUComponent.UpdatePhbkPhoneView:Update Phone`,
    };
