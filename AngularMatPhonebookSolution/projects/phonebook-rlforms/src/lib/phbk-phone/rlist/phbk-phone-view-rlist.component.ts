...
export class PhbkPhoneViewRlistComponent implements OnInit, OnDestroy, IEventEmitterPub, IItemHeightData {
    frases: {[key:string]: string}  = {
        ...
        'permission': $localize`:Permission@@PhbkPhoneViewRlistComponent.permission:Permission`,
        'accessdenied': $localize`:Access denied@@PhbkPhoneViewRlistComponent.accessdenied:Access denied`,
