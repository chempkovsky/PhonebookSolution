...
export class PhbkDivisionViewRlistComponent implements OnInit, OnDestroy, IEventEmitterPub, IItemHeightData {
    frases: {[key:string]: string}  = {
        ...
        'permission': $localize`:Permission@@PhbkDivisionViewRlistComponent.permission:Permission`,
        'accessdenied': $localize`:Access denied@@PhbkDivisionViewRlistComponent.accessdenied:Access denied`,
