...
import { PhbkDivisionViewDformComponent } from 'phonebook-updforms';

@Component({
  selector: 'app-phbk-division-view-r-d',
  templateUrl: './phbk-division-view-r-d.component.html',
  styleUrls: ['./phbk-division-view-r-d.component.css']
})

export class PhbkDivisionViewRDComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Delete Division@@PhbkDivisionViewRDComponent.DeletePhbkDivisionView:Delete Division`,
    };
