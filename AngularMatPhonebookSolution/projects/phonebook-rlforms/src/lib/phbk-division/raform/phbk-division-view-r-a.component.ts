...
import { PhbkDivisionViewAformComponent } from 'phonebook-updforms';


@Component({
  selector: 'app-phbk-division-view-r-a',
  templateUrl: './phbk-division-view-r-a.component.html',
  styleUrls: ['./phbk-division-view-r-a.component.css']
})

export class PhbkDivisionViewRAComponent implements OnInit, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'title': $localize`:Add Division@@PhbkDivisionViewRAComponent.AddPhbkDivisionView:Add Division`,
    };
