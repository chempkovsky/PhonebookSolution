...
@Component({
  selector: 'app-phbk-enterprise-view-vform',
  templateUrl: './phbk-enterprise-view-vform.component.html',
  styleUrls: ['./phbk-enterprise-view-vform.component.css']
})
export class PhbkEnterpriseViewVformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkEnterpriseViewVformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Review Enterprise@@PhbkEnterpriseViewVformComponent.Review-Item:Review Enterprise`,
        'title': $localize`:Select Item@@PhbkEnterpriseViewVformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkEnterpriseViewVformComponent.Not-all-masters:Not all masters have been set`,
    ...
    public doSubmit(): void {
        ...
        let data: IPhbkEnterpriseView = this.rootDataSource.values2Interface();
...
} // the end of the PhbkEnterpriseViewVformComponent class body
