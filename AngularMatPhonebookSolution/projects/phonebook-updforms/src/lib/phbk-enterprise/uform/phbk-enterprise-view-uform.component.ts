...
@Component({
  selector: 'app-phbk-enterprise-view-uform',
  templateUrl: './phbk-enterprise-view-uform.component.html',
  styleUrls: ['./phbk-enterprise-view-uform.component.css']
})
export class PhbkEnterpriseViewUformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkEnterpriseViewUformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Update Enterprise@@PhbkEnterpriseViewUformComponent.Update-Item:Update Enterprise`,
        'title': $localize`:Select Item@@PhbkEnterpriseViewUformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkEnterpriseViewUformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkEnterpriseViewUformComponent class body
