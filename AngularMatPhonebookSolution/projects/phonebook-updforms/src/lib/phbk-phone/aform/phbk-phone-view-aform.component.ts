...
@Component({
  selector: 'app-phbk-phone-view-aform',
  templateUrl: './phbk-phone-view-aform.component.html',
  styleUrls: ['./phbk-phone-view-aform.component.css']
})
export class PhbkPhoneViewAformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkPhoneViewAformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Add Phone@@PhbkPhoneViewAformComponent.Review-Item:Add Phone`,
        'title': $localize`:Select Item@@PhbkPhoneViewAformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkPhoneViewAformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkPhoneViewAformComponent class body
