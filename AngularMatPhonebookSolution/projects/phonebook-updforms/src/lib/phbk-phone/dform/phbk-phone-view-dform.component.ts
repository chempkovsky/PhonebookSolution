...
@Component({
  selector: 'app-phbk-phone-view-dform',
  templateUrl: './phbk-phone-view-dform.component.html',
  styleUrls: ['./phbk-phone-view-dform.component.css']
})
export class PhbkPhoneViewDformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkPhoneViewDformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Delete Phone@@PhbkPhoneViewDformComponent.Delete-Item:Delete Phone`,
        'title': $localize`:Select Item@@PhbkPhoneViewDformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkPhoneViewDformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkPhoneViewDformComponent class body
