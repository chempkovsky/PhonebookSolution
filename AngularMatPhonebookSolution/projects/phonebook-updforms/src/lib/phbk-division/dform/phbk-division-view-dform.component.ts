...
@Component({
  selector: 'app-phbk-division-view-dform',
  templateUrl: './phbk-division-view-dform.component.html',
  styleUrls: ['./phbk-division-view-dform.component.css']
})
export class PhbkDivisionViewDformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkDivisionViewDformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Delete Division@@PhbkDivisionViewDformComponent.Delete-Item:Delete Division`,
        'title': $localize`:Select Item@@PhbkDivisionViewDformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkDivisionViewDformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkDivisionViewDformComponent class body
