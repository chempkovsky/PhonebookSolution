...
@Component({
  selector: 'app-phbk-employee-view-dform',
  templateUrl: './phbk-employee-view-dform.component.html',
  styleUrls: ['./phbk-employee-view-dform.component.css']
})
export class PhbkEmployeeViewDformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkEmployeeViewDformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Delete Employee@@PhbkEmployeeViewDformComponent.Delete-Item:Delete Employee`,
        'title': $localize`:Select Item@@PhbkEmployeeViewDformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkEmployeeViewDformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkEmployeeViewDformComponent class body
