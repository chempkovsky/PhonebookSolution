...
@Component({
  selector: 'app-phbk-employee-view-uform',
  templateUrl: './phbk-employee-view-uform.component.html',
  styleUrls: ['./phbk-employee-view-uform.component.css']
})
export class PhbkEmployeeViewUformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkEmployeeViewUformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Update Employee@@PhbkEmployeeViewUformComponent.Update-Item:Update Employee`,
        'title': $localize`:Select Item@@PhbkEmployeeViewUformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkEmployeeViewUformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkEmployeeViewUformComponent class body
