...
@Component({
  selector: 'app-phbk-phone-type-view-uform',
  templateUrl: './phbk-phone-type-view-uform.component.html',
  styleUrls: ['./phbk-phone-type-view-uform.component.css']
})
export class PhbkPhoneTypeViewUformComponent implements OnInit, OnDestroy, IEventEmitterPub {
    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkPhoneTypeViewUformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Update Phone Type@@PhbkPhoneTypeViewUformComponent.Update-Item:Update Phone Type`,
        'title': $localize`:Select Item@@PhbkPhoneTypeViewUformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkPhoneTypeViewUformComponent.Not-all-masters:Not all masters have been set`,
...
} // the end of the PhbkPhoneTypeViewUformComponent class body
