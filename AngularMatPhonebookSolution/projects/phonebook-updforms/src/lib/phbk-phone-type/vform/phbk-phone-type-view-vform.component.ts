...
@Component({
  selector: 'app-phbk-phone-type-view-vform',
  templateUrl: './phbk-phone-type-view-vform.component.html',
  styleUrls: ['./phbk-phone-type-view-vform.component.css']
})
export class PhbkPhoneTypeViewVformComponent implements OnInit, OnDestroy, IEventEmitterPub {

    frases: {[key:string]: string}  = {
        'Not-all-props': $localize`:Not all properties are set@@PhbkPhoneTypeViewVformComponent.Not-all-props:Not all properties are set`,
        'caption': $localize`:Review Phone Type@@PhbkPhoneTypeViewVformComponent.Review-Item:Review Phone Type`,
        'title': $localize`:Select Item@@PhbkPhoneTypeViewVformComponent.SelItem:Select Item`,
        'Not-all-masters': $localize`:Not all masters have been set@@PhbkPhoneTypeViewVformComponent.Not-all-masters:Not all masters have been set`,
    ...
    public doSubmit(): void {
        ...
        let data: IPhbkPhoneTypeView = this.rootDataSource.values2Interface();
...
} // the end of the PhbkPhoneTypeViewVformComponent class body
